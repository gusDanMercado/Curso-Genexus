   ...
   public class viewpais : GXDataArea
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12PaisID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12PaisID", StringUtil.LTrimStr( (decimal)(AV12PaisID), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12PaisID), "ZZZZZ9"), context));
      ...
      {
         GxWebStd.gx_hidden_field( context, "vPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12PaisID), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12PaisID), "ZZZZZ9"), context));
      ...
      {
         return formatLink("viewpais.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12PaisID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"PaisID","TabCode"})  ;
      }
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Pais", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewPais.htm");
            ...
            GxWebStd.gx_label_element( context, edtPaisNombre_Internalname, "Nombre", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtPaisNombre_Internalname, A2PaisNombre, StringUtil.RTrim( context.localUtil.Format( A2PaisNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "Descripcion", "start", true, "", "HLP_ViewPais.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblVendedor_title_Internalname, "Vendedor", "", "", lblVendedor_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPais.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablevendedor_Internalname, 1, 0, "px", 0, "px", "ww__view__tab__form-container", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0034"+"", StringUtil.RTrim( WebComp_Vendedorwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablecliente_Internalname, 1, 0, "px", 0, "px", "ww__view__tab__form-container", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0042"+"", StringUtil.RTrim( WebComp_Clientewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProducto_title_Internalname, "Pais Producto", "", "", lblProducto_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPais.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0050"+"", StringUtil.RTrim( WebComp_Productowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 34 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Vendedorwc_Component) != 0 )
                           {
                              WebComp_Vendedorwc.componentprocess("W0034", "", sEvt);
                           }
                           WebComp_Vendedorwc_Component = OldVendedorwc;
                        }
                        else if ( nCmpId == 42 )
                        {
                           OldClientewc = cgiGet( "W0042");
                           ...
                           if ( StringUtil.Len( WebComp_Clientewc_Component) != 0 )
                           {
                              WebComp_Clientewc.componentprocess("W0042", "", sEvt);
                           }
                           WebComp_Clientewc_Component = OldClientewc;
                        }
                        else if ( nCmpId == 50 )
                        {
                           OldProductowc = cgiGet( "W0050");
                           ...
                           if ( StringUtil.Len( WebComp_Productowc_Component) != 0 )
                           {
                              WebComp_Productowc.componentprocess("W0050", "", sEvt);
                           }
                           WebComp_Productowc_Component = OldProductowc;
                        }
                     }
      ...
      protected void RF052( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1PaisID = H00052_A1PaisID[0];
               A2PaisNombre = H00052_A2PaisNombre[0];
      ...
      protected void STRUP050( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12PaisID = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vPAISID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E11052( )
      {
         ...
         {
            A1PaisID = H00053_A1PaisID[0];
            A2PaisNombre = H00053_A2PaisNombre[0];
            AssignAttri("", false, "A2PaisNombre", A2PaisNombre);
            AV14GXLvl7 = 1;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12PaisID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Vendedor") == 0 ) )
         {
            ...
            if ( true )
            {
               bDynCreated_Vendedorwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Vendedorwc_Component), StringUtil.Lower( "PaisVendedorWC")) != 0 )
            {
               WebComp_Vendedorwc = getWebComponent(GetType(), "GeneXus.Programs", "paisvendedorwc", new Object[] {context} );
               WebComp_Vendedorwc.ComponentInit();
               WebComp_Vendedorwc.Name = "PaisVendedorWC";
               WebComp_Vendedorwc_Component = "PaisVendedorWC";
            }
            if ( StringUtil.Len( WebComp_Vendedorwc_Component) != 0 )
            {
               WebComp_Vendedorwc.setjustcreated();
               WebComp_Vendedorwc.componentprepare(new Object[] {(string)"W0034",(string)"",(int)AV12PaisID});
               WebComp_Vendedorwc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Vendedorwc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0034"+"");
               WebComp_Vendedorwc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Cliente") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Clientewc_Component) != 0 )
            {
               ...
               WebComp_Clientewc.componentprepare(new Object[] {(string)"W0042",(string)"",(int)AV12PaisID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Producto") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productowc_Component), StringUtil.Lower( "PaisProductoWC")) != 0 )
            {
               WebComp_Productowc = getWebComponent(GetType(), "GeneXus.Programs", "paisproductowc", new Object[] {context} );
               WebComp_Productowc.ComponentInit();
               WebComp_Productowc.Name = "PaisProductoWC";
               WebComp_Productowc_Component = "PaisProductoWC";
            }
            if ( StringUtil.Len( WebComp_Productowc_Component) != 0 )
            {
               WebComp_Productowc.setjustcreated();
               WebComp_Productowc.componentprepare(new Object[] {(string)"W0050",(string)"",(int)AV12PaisID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12PaisID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12PaisID", StringUtil.LTrimStr( (decimal)(AV12PaisID), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12PaisID), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522048358", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewpais.js", "?2025522048358", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12PaisID","fld":"vPAISID","pic":"ZZZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A2PaisNombre","fld":"PAISNOMBRE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H00052_A1PaisID = new int[1] ;
         H00052_A2PaisNombre = new string[] {""} ;
         hsh = "";
         H00053_A1PaisID = new int[1] ;
         H00053_A2PaisNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewpais__default(),
            new Object[][] {
                new Object[] {
               H00052_A1PaisID, H00052_A2PaisNombre
               }
               , new Object[] {
               H00053_A1PaisID, H00053_A2PaisNombre
               }
            }
         );
      ...
      private int AV12PaisID ;
      private int wcpOAV12PaisID ;
      ...
      private bool bDynCreated_Vendedorwc ;
      ...
      private int[] H00052_A1PaisID ;
      private string[] H00052_A2PaisNombre ;
      private int[] H00053_A1PaisID ;
      private string[] H00053_A2PaisNombre ;
   ...
   public class viewpais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12PaisID",GXType.Int32,6,0)
          };
          Object[] prmH00053;
          ...
          def= new CursorDef[] {
              new CursorDef("H00052", "SELECT [PaisID], [PaisNombre] FROM [Pais] WHERE [PaisID] = @AV12PaisID ORDER BY [PaisID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00052,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00053", "SELECT [PaisID], [PaisNombre] FROM [Pais] WHERE [PaisID] = @AV12PaisID ORDER BY [PaisID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00053,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
