...
namespace GeneXus.Programs {
   public class paisclientewc : GXWebComponent
   {
      public paisclientewc( )
      {
      ...
      public paisclientewc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Pais Cliente WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paisclientewc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6PaisID,6,0))}, new string[] {"PaisID"}) +"\">") ;
      ...
      {
         return "PaisClienteWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Pais Cliente WC" ;
      }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "paisclientewc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_PaisClienteWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 33,'" + sPrefix + "',false,'" + sGXsfl_22_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtPaisID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisID), 6, 0, ".", "")), StringUtil.LTrim( ((edtPaisID_Enabled!=0) ? context.localUtil.Format( (decimal)(A1PaisID), "ZZZZZ9") : context.localUtil.Format( (decimal)(A1PaisID), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,33);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisID_Jsonclick, 0, "Attribute", "", "", "", "", edtPaisID_Visible, edtPaisID_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "ID", "end", false, "", "HLP_PaisClienteWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0H2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Pais Cliente WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CLIENTEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A9ClienteID), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ClienteID), 6, 0, ".", "")));
      }
      ...
      protected void RF0H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1PaisID = H000H2_A1PaisID[0];
               AssignAttri(sPrefix, false, "A1PaisID", StringUtil.LTrimStr( (decimal)(A1PaisID), 6, 0));
               A13ClienteTelefono = H000H2_A13ClienteTelefono[0];
               A12ClienteEmail = H000H2_A12ClienteEmail[0];
               A11ClienteDireccion = H000H2_A11ClienteDireccion[0];
               A10ClienteNombre = H000H2_A10ClienteNombre[0];
               A9ClienteID = H000H2_A9ClienteID[0];
               /* Execute user event: Grid.Load */
               E130H2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CLIENTEID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A9ClienteID), "ZZZZZ9"), context));
      }
      ...
      private void E130H2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("cliente.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A9ClienteID,6,0))}, new string[] {"Mode","ClienteID"}) ;
         edtavDelete_Link = formatLink("cliente.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A9ClienteID,6,0))}, new string[] {"Mode","ClienteID"}) ;
      ...
      protected void E110H2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("cliente.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","ClienteID"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "paisclientewc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522048141", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("paisclientewc.js", "?2025522048141", false, true);
         }
      ...
      protected void SubsflControlProps_222( )
      {
         ...
         edtClienteNombre_Internalname = sPrefix+"CLIENTENOMBRE_"+sGXsfl_22_idx;
         edtClienteDireccion_Internalname = sPrefix+"CLIENTEDIRECCION_"+sGXsfl_22_idx;
         edtClienteEmail_Internalname = sPrefix+"CLIENTEEMAIL_"+sGXsfl_22_idx;
         edtClienteTelefono_Internalname = sPrefix+"CLIENTETELEFONO_"+sGXsfl_22_idx;
      ...
      protected void SubsflControlProps_fel_222( )
      {
         ...
         edtClienteNombre_Internalname = sPrefix+"CLIENTENOMBRE_"+sGXsfl_22_fel_idx;
         edtClienteDireccion_Internalname = sPrefix+"CLIENTEDIRECCION_"+sGXsfl_22_fel_idx;
         edtClienteEmail_Internalname = sPrefix+"CLIENTEEMAIL_"+sGXsfl_22_fel_idx;
         edtClienteTelefono_Internalname = sPrefix+"CLIENTETELEFONO_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ClienteID), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A9ClienteID), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtClienteID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteDireccion_Internalname,(string)A11ClienteDireccion,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A11ClienteDireccion),(string)"_blank",(string)"",(string)"",(string)edtClienteDireccion_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtClienteEmail_Internalname,(string)A12ClienteEmail,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"mailto:"+A12ClienteEmail,(string)"",(string)"",(string)"",(string)edtClienteEmail_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"email",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Email",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 29,'" + sPrefix + "',false,'" + sGXsfl_22_idx + "',22)\"";
            ROClassString = "TextActionAttribute TextLikeLink";
      ...
      protected void StartGridControl22( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A11ClienteDireccion));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A12ClienteEmail));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A13ClienteTelefono)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtClienteDireccion_Internalname = sPrefix+"CLIENTEDIRECCION";
         edtClienteEmail_Internalname = sPrefix+"CLIENTEEMAIL";
         edtClienteTelefono_Internalname = sPrefix+"CLIENTETELEFONO";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E130H2","iparms":[{"av":"A9ClienteID","fld":"CLIENTEID","pic":"ZZZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtClienteNombre_Link","ctrl":"CLIENTENOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110H2","iparms":[{"av":"A9ClienteID","fld":"CLIENTEID","pic":"ZZZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         A12ClienteEmail = "";
         A13ClienteTelefono = "";
         H000H2_A1PaisID = new int[1] ;
         H000H2_A13ClienteTelefono = new string[] {""} ;
         H000H2_A12ClienteEmail = new string[] {""} ;
         H000H2_A11ClienteDireccion = new string[] {""} ;
         H000H2_A10ClienteNombre = new string[] {""} ;
         H000H2_A9ClienteID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisclientewc__default(),
            new Object[][] {
                new Object[] {
               H000H2_A1PaisID, H000H2_A13ClienteTelefono, H000H2_A12ClienteEmail, H000H2_A11ClienteDireccion, H000H2_A10ClienteNombre, H000H2_A9ClienteID
               }
               , new Object[] {
      ...
      private int[] H000H2_A1PaisID ;
      private string[] H000H2_A13ClienteTelefono ;
      private string[] H000H2_A12ClienteEmail ;
      private string[] H000H2_A11ClienteDireccion ;
      private string[] H000H2_A10ClienteNombre ;
      private int[] H000H2_A9ClienteID ;
   ...
   public class paisclientewc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000H2", "SELECT [PaisID], [ClienteTelefono], [ClienteEmail], [ClienteDireccion], [ClienteNombre], [ClienteID] FROM [Cliente] WHERE [PaisID] = @AV6PaisID ORDER BY [PaisID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000H3", "SELECT COUNT(*) FROM [Cliente] WHERE [PaisID] = @AV6PaisID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000H3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
