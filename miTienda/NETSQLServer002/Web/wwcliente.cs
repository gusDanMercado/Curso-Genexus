...
namespace GeneXus.Programs {
   public class wwcliente : GXDataArea
   {
      public wwcliente( )
      {
      ...
      public wwcliente( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11ClienteNombre = GetPar( "ClienteNombre");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11ClienteNombre, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwcliente.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCLIENTENOMBRE", AV11ClienteNombre);
         /* Send saved values. */
      ...
      {
         return formatLink("wwcliente.aspx")  ;
      }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Clientes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWCliente.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavClientenombre_Internalname, "Cliente Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavClientenombre_Internalname, AV11ClienteNombre, StringUtil.RTrim( context.localUtil.Format( AV11ClienteNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavClientenombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavClientenombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWCliente.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Clientenombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCLIENTENOMBRE"), AV11ClienteNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0K2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavClientenombre_Internalname;
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11ClienteNombre = StringUtil.Concat( StringUtil.RTrim( AV11ClienteNombre), "%", "");
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {lV11ClienteNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A13ClienteTelefono = H000K2_A13ClienteTelefono[0];
               A12ClienteEmail = H000K2_A12ClienteEmail[0];
               A11ClienteDireccion = H000K2_A11ClienteDireccion[0];
               A2PaisNombre = H000K2_A2PaisNombre[0];
               A1PaisID = H000K2_A1PaisID[0];
               A10ClienteNombre = H000K2_A10ClienteNombre[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CLIENTEID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A9ClienteID), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11ClienteNombre = StringUtil.Concat( StringUtil.RTrim( AV11ClienteNombre), "%", "");
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {lV11ClienteNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11ClienteNombre = GridState.FilterValues("Clientenombre");
            AssignAttri("", false, "AV11ClienteNombre", AV11ClienteNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("ClienteNombre", AV11ClienteNombre);
      }
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11ClienteNombre = cgiGet( edtavClientenombre_Internalname);
            AssignAttri("", false, "AV11ClienteNombre", AV11ClienteNombre);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Cliente";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202552012467", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcliente.js", "?202552012467", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtClienteNombre_Internalname = "CLIENTENOMBRE_"+sGXsfl_27_idx;
         edtPaisID_Internalname = "PAISID_"+sGXsfl_27_idx;
         edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_27_idx;
         edtClienteDireccion_Internalname = "CLIENTEDIRECCION_"+sGXsfl_27_idx;
         edtClienteEmail_Internalname = "CLIENTEEMAIL_"+sGXsfl_27_idx;
         edtClienteTelefono_Internalname = "CLIENTETELEFONO_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtClienteNombre_Internalname = "CLIENTENOMBRE_"+sGXsfl_27_fel_idx;
         edtPaisID_Internalname = "PAISID_"+sGXsfl_27_fel_idx;
         edtPaisNombre_Internalname = "PAISNOMBRE_"+sGXsfl_27_fel_idx;
         edtClienteDireccion_Internalname = "CLIENTEDIRECCION_"+sGXsfl_27_fel_idx;
         edtClienteEmail_Internalname = "CLIENTEEMAIL_"+sGXsfl_27_fel_idx;
         edtClienteTelefono_Internalname = "CLIENTETELEFONO_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 35,'',false,'" + sGXsfl_27_idx + "',27)\"";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ClienteNombre","fld":"vCLIENTENOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140K2","iparms":[{"av":"A9ClienteID","fld":"CLIENTEID","pic":"ZZZZZ9","hsh":true},{"av":"A1PaisID","fld":"PAISID","pic":"ZZZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtClienteNombre_Link","ctrl":"CLIENTENOMBRE","prop":"Link"},{"av":"edtPaisNombre_Link","ctrl":"PAISNOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110K2","iparms":[{"av":"A9ClienteID","fld":"CLIENTEID","pic":"ZZZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ClienteNombre","fld":"vCLIENTENOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ClienteNombre","fld":"vCLIENTENOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ClienteNombre","fld":"vCLIENTENOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ClienteNombre","fld":"vCLIENTENOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11ClienteNombre = "";
         H000K2_A13ClienteTelefono = new string[] {""} ;
         H000K2_A12ClienteEmail = new string[] {""} ;
         H000K2_A11ClienteDireccion = new string[] {""} ;
         H000K2_A2PaisNombre = new string[] {""} ;
         H000K2_A1PaisID = new int[1] ;
         H000K2_A10ClienteNombre = new string[] {""} ;
         H000K2_A9ClienteID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcliente__default(),
            new Object[][] {
                new Object[] {
               H000K2_A13ClienteTelefono, H000K2_A12ClienteEmail, H000K2_A11ClienteDireccion, H000K2_A2PaisNombre, H000K2_A1PaisID, H000K2_A10ClienteNombre, H000K2_A9ClienteID
               }
               , new Object[] {
      ...
      private int edtavClientenombre_Enabled ;
      ...
      private string AV11ClienteNombre ;
      ...
      private string lV11ClienteNombre ;
      ...
      private string[] H000K2_A13ClienteTelefono ;
      private string[] H000K2_A12ClienteEmail ;
      private string[] H000K2_A11ClienteDireccion ;
      private string[] H000K2_A2PaisNombre ;
      private int[] H000K2_A1PaisID ;
      private string[] H000K2_A10ClienteNombre ;
      private int[] H000K2_A9ClienteID ;
   ...
   public class wwcliente__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A10ClienteNombre )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[ClienteTelefono], T1.[ClienteEmail], T1.[ClienteDireccion], T2.[PaisNombre], T1.[PaisID], T1.[ClienteNombre], T1.[ClienteID]";
         sFromString = " FROM ([Cliente] T1 INNER JOIN [Pais] T2 ON T2.[PaisID] = T1.[PaisID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ClienteNombre)) )
         {
            AddWhere(sWhereString, "(T1.[ClienteNombre] like @lV11ClienteNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[ClienteNombre]";
                                             ...
                                             string A10ClienteNombre )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Cliente] T1 INNER JOIN [Pais] T2 ON T2.[PaisID] = T1.[PaisID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ClienteNombre)) )
         {
            AddWhere(sWhereString, "(T1.[ClienteNombre] like @lV11ClienteNombre)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11ClienteNombre",GXType.NVarChar,80,0) ,
