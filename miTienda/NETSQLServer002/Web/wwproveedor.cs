...
namespace GeneXus.Programs {
   public class wwproveedor : GXDataArea
   {
      public wwproveedor( )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11ProveedorNombre = GetPar( "ProveedorNombre");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11ProveedorNombre, AV12Update, AV13Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPROVEEDORNOMBRE", AV11ProveedorNombre);
         /* Send saved values. */
      ...
      {
         return formatLink("wwproveedor.aspx")  ;
      }
      ...
      protected void WB0P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWProveedor.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavProveedornombre_Internalname, "Proveedor Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavProveedornombre_Internalname, AV11ProveedorNombre, StringUtil.RTrim( context.localUtil.Format( AV11ProveedorNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavProveedornombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavProveedornombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWProveedor.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Proveedornombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vPROVEEDORNOMBRE"), AV11ProveedorNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0P2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavProveedornombre_Internalname;
      ...
      protected void RF0P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11ProveedorNombre = StringUtil.Concat( StringUtil.RTrim( AV11ProveedorNombre), "%", "");
            /* Using cursor H000P2 */
            pr_default.execute(0, new Object[] {lV11ProveedorNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A18ProveedorNombre = H000P2_A18ProveedorNombre[0];
               A17ProveedorID = H000P2_A17ProveedorID[0];
               /* Execute user event: Grid.Load */
               E140P2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PROVEEDORID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A17ProveedorID), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11ProveedorNombre = StringUtil.Concat( StringUtil.RTrim( AV11ProveedorNombre), "%", "");
         /* Using cursor H000P3 */
         pr_default.execute(1, new Object[] {lV11ProveedorNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11ProveedorNombre = GridState.FilterValues("Proveedornombre");
            AssignAttri("", false, "AV11ProveedorNombre", AV11ProveedorNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("ProveedorNombre", AV11ProveedorNombre);
      }
      ...
      protected void STRUP0P0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11ProveedorNombre = cgiGet( edtavProveedornombre_Internalname);
            AssignAttri("", false, "AV11ProveedorNombre", AV11ProveedorNombre);
      ...
      private void E140P2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("proveedor.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A17ProveedorID,6,0))}, new string[] {"Mode","ProveedorID"}) ;
         edtavDelete_Link = formatLink("proveedor.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A17ProveedorID,6,0))}, new string[] {"Mode","ProveedorID"}) ;
         edtProveedorNombre_Link = formatLink("viewproveedor.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A17ProveedorID,6,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"ProveedorID","TabCode"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 27;
      ...
      protected void E110P2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("proveedor.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","ProveedorID"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Proveedor";
      ...
      {
         edtProveedorID_Internalname = "PROVEEDORID_"+sGXsfl_27_idx;
         edtProveedorNombre_Internalname = "PROVEEDORNOMBRE_"+sGXsfl_27_idx;
      ...
      {
         edtProveedorID_Internalname = "PROVEEDORID_"+sGXsfl_27_fel_idx;
         edtProveedorNombre_Internalname = "PROVEEDORNOMBRE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProveedorID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A17ProveedorID), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A17ProveedorID), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProveedorID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A17ProveedorID), 6, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A18ProveedorNombre));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtProveedorNombre_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavProveedornombre_Internalname = "vPROVEEDORNOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtProveedorNombre_Enabled = 0;
         edtProveedorID_Enabled = 0;
         edtavProveedornombre_Jsonclick = "";
         edtavProveedornombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProveedorNombre","fld":"vPROVEEDORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140P2","iparms":[{"av":"A17ProveedorID","fld":"PROVEEDORID","pic":"ZZZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtProveedorNombre_Link","ctrl":"PROVEEDORNOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110P2","iparms":[{"av":"A17ProveedorID","fld":"PROVEEDORID","pic":"ZZZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProveedorNombre","fld":"vPROVEEDORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProveedorNombre","fld":"vPROVEEDORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProveedorNombre","fld":"vPROVEEDORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProveedorNombre","fld":"vPROVEEDORNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11ProveedorNombre = "";
         H000P2_A18ProveedorNombre = new string[] {""} ;
         H000P2_A17ProveedorID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwproveedor__default(),
            new Object[][] {
                new Object[] {
               H000P2_A18ProveedorNombre, H000P2_A17ProveedorID
               }
               , new Object[] {
      ...
      private int edtavProveedornombre_Enabled ;
      ...
      private string edtavProveedornombre_Internalname ;
      private string edtavProveedornombre_Jsonclick ;
      ...
      private string AV11ProveedorNombre ;
      private string A18ProveedorNombre ;
      private string lV11ProveedorNombre ;
      ...
      private string[] H000P2_A18ProveedorNombre ;
      private int[] H000P2_A17ProveedorID ;
   ...
   public class wwproveedor__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A18ProveedorNombre )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ProveedorNombre)) )
         {
            AddWhere(sWhereString, "([ProveedorNombre] like @lV11ProveedorNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [ProveedorNombre]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11ProveedorNombre",GXType.NVarChar,80,0) ,
