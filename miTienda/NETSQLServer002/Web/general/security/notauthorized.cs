   ...
   public class notauthorized : GXDataArea
   {
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_3_042( true) ;
         }
         else
         {
            wb_table1_3_042( false) ;
         }
         return  ;
      }

      protected void wb_table1_3_042e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_12_042( true) ;
         }
         else
         {
            wb_table2_12_042( false) ;
         }
         return  ;
      }

      protected void wb_table2_12_042e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_15_042( true) ;
         }
         else
         {
            wb_table3_15_042( false) ;
         }
         return  ;
      }

      protected void wb_table3_15_042e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_15_042( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_15_042e( true) ;
         }
         else
         {
            wb_table3_15_042e( false) ;
         }
      }

      protected void wb_table2_12_042( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_12_042e( true) ;
         }
         else
         {
            wb_table2_12_042e( false) ;
         }
      }

      protected void wb_table1_3_042( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_3_042e( true) ;
         }
         else
         {
            wb_table1_3_042e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522048793", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/security/notauthorized.js", "?2025522048793", false, true);
