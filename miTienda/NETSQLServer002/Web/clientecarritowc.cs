...
namespace GeneXus.Programs {
   public class clientecarritowc : GXWebComponent
   {
      public clientecarritowc( )
      {
      ...
      public clientecarritowc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Cliente Carrito WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("clientecarritowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ClienteID,6,0))}, new string[] {"ClienteID"}) +"\">") ;
      ...
      {
         return "ClienteCarritoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Cliente Carrito WC" ;
      }
      ...
      protected void WB130( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "clientecarritowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ClienteCarritoWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtClienteID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ClienteID), 6, 0, ".", "")), StringUtil.LTrim( ((edtClienteID_Enabled!=0) ? context.localUtil.Format( (decimal)(A9ClienteID), "ZZZZZ9") : context.localUtil.Format( (decimal)(A9ClienteID), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,32);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClienteID_Jsonclick, 0, "Attribute", "", "", "", "", edtClienteID_Visible, edtClienteID_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "ID", "end", false, "", "HLP_ClienteCarritoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START132( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Cliente Carrito WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CARRITOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A33CarritoID), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CARRITOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A33CarritoID), 6, 0, ".", "")));
      }
      ...
      protected void RF132( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A9ClienteID = H00133_A9ClienteID[0];
               AssignAttri(sPrefix, false, "A9ClienteID", StringUtil.LTrimStr( (decimal)(A9ClienteID), 6, 0));
               A33CarritoID = H00133_A33CarritoID[0];
               A36CarritoCostoTotalCompra = H00133_A36CarritoCostoTotalCompra[0];
               n36CarritoCostoTotalCompra = H00133_n36CarritoCostoTotalCompra[0];
               A34CarritoFchCompra = H00133_A34CarritoFchCompra[0];
               A36CarritoCostoTotalCompra = H00133_A36CarritoCostoTotalCompra[0];
               n36CarritoCostoTotalCompra = H00133_n36CarritoCostoTotalCompra[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CARRITOID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A33CarritoID), "ZZZZZ9"), context));
      }
      ...
      private void E13132( )
      {
         ...
         edtavDelete_Link = formatLink("carrito.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A33CarritoID,6,0))}, new string[] {"Mode","CarritoID"}) ;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "clientecarritowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522048278", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("clientecarritowc.js", "?2025522048278", false, true);
         }
      ...
      {
         edtCarritoID_Internalname = sPrefix+"CARRITOID_"+sGXsfl_22_idx;
         edtCarritoFchCompra_Internalname = sPrefix+"CARRITOFCHCOMPRA_"+sGXsfl_22_idx;
         edtCarritoFchEntrega_Internalname = sPrefix+"CARRITOFCHENTREGA_"+sGXsfl_22_idx;
         edtCarritoCostoTotalCompra_Internalname = sPrefix+"CARRITOCOSTOTOTALCOMPRA_"+sGXsfl_22_idx;
      ...
      {
         edtCarritoID_Internalname = sPrefix+"CARRITOID_"+sGXsfl_22_fel_idx;
         edtCarritoFchCompra_Internalname = sPrefix+"CARRITOFCHCOMPRA_"+sGXsfl_22_fel_idx;
         edtCarritoFchEntrega_Internalname = sPrefix+"CARRITOFCHENTREGA_"+sGXsfl_22_fel_idx;
         edtCarritoCostoTotalCompra_Internalname = sPrefix+"CARRITOCOSTOTOTALCOMPRA_"+sGXsfl_22_fel_idx;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E13132","iparms":[{"av":"A33CarritoID","fld":"CARRITOID","pic":"ZZZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtCarritoFchCompra_Link","ctrl":"CARRITOFCHCOMPRA","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E11132","iparms":[{"av":"A33CarritoID","fld":"CARRITOID","pic":"ZZZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         H00133_A9ClienteID = new int[1] ;
         H00133_A33CarritoID = new int[1] ;
         H00133_A36CarritoCostoTotalCompra = new decimal[1] ;
         H00133_n36CarritoCostoTotalCompra = new bool[] {false} ;
         H00133_A34CarritoFchCompra = new DateTime[] {DateTime.MinValue} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientecarritowc__default(),
            new Object[][] {
                new Object[] {
               H00133_A9ClienteID, H00133_A33CarritoID, H00133_A36CarritoCostoTotalCompra, H00133_n36CarritoCostoTotalCompra, H00133_A34CarritoFchCompra
               }
               , new Object[] {
      ...
      private int[] H00133_A9ClienteID ;
      private int[] H00133_A33CarritoID ;
      private decimal[] H00133_A36CarritoCostoTotalCompra ;
      private bool[] H00133_n36CarritoCostoTotalCompra ;
      private DateTime[] H00133_A34CarritoFchCompra ;
   ...
   public class clientecarritowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00133", "SELECT T1.[ClienteID], T1.[CarritoID], COALESCE( T2.[CarritoCostoTotalCompra], 0) AS CarritoCostoTotalCompra, T1.[CarritoFchCompra] FROM ([Carrito] T1 LEFT JOIN (SELECT SUM(T4.[ProductoPrecio] * CAST(T3.[CarritoDetalleCompraCantidadUn] AS decimal( 20, 10))) AS CarritoCostoTotalCompra, T3.[CarritoID] FROM ([CarritoDetalleCompra] T3 INNER JOIN [Producto] T4 ON T4.[ProductoID] = T3.[ProductoID]) GROUP BY T3.[CarritoID] ) T2 ON T2.[CarritoID] = T1.[CarritoID]) WHERE T1.[ClienteID] = @AV6ClienteID ORDER BY T1.[ClienteID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00133,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00135", "SELECT COUNT(*) FROM ([Carrito] T1 LEFT JOIN (SELECT SUM(T4.[ProductoPrecio] * CAST(T3.[CarritoDetalleCompraCantidadUn] AS decimal( 20, 10))) AS CarritoCostoTotalCompra, T3.[CarritoID] FROM ([CarritoDetalleCompra] T3 INNER JOIN [Producto] T4 ON T4.[ProductoID] = T3.[ProductoID]) GROUP BY T3.[CarritoID] ) T2 ON T2.[CarritoID] = T1.[CarritoID]) WHERE T1.[ClienteID] = @AV6ClienteID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00135,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
