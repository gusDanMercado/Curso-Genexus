...
namespace GeneXus.Programs {
   public class gx0010 : GXDataArea
   {
      ...
      public void execute( out int aP0_pPaisID )
      {
         this.AV8pPaisID = 0 ;
         ExecuteImpl();
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV8pPaisID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV8pPaisID", StringUtil.LTrimStr( (decimal)(AV8pPaisID), 6, 0));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV6cPaisID = (int)(Math.Round(NumberUtil.Val( GetPar( "cPaisID"), "."), 18, MidpointRounding.ToEven));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0010.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pPaisID,6,0))}, new string[] {"pPaisID"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cPaisID), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCPAISNOMBRE", AV7cPaisNombre);
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
         GxWebStd.gx_hidden_field( context, "nRC_GXsfl_34", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_34), 8, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pPaisID), 6, 0, ".", "")));
      ...
      {
         return formatLink("gx0010.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8pPaisID,6,0))}, new string[] {"pPaisID"})  ;
      }
      ...
      protected void WB030( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblpaisidfilter_Internalname, "Pais ID", "", "", lblLblpaisidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11031_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCpaisid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cPaisID), 6, 0, ".", "")), StringUtil.LTrim( ((edtavCpaisid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cPaisID), "ZZZZZ9") : context.localUtil.Format( (decimal)(AV6cPaisID), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCpaisid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCpaisid_Visible, edtavCpaisid_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblpaisnombrefilter_Internalname, "Pais Nombre", "", "", lblLblpaisnombrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12031_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0010.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), !bGXsfl_34_Refreshing);
      ...
      protected void RF032( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7cPaisNombre = StringUtil.Concat( StringUtil.RTrim( AV7cPaisNombre), "%", "");
            /* Using cursor H00032 */
            ...
            {
               A40000PaisBandera_GXI = H00032_A40000PaisBandera_GXI[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), !bGXsfl_34_Refreshing);
               AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandera), true);
               A2PaisNombre = H00032_A2PaisNombre[0];
               A1PaisID = H00032_A1PaisID[0];
               A3PaisBandera = H00032_A3PaisBandera[0];
               AssignProp("", false, edtPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), !bGXsfl_34_Refreshing);
               AssignProp("", false, edtPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandera), true);
               /* Execute user event: Load */
               E15032 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID"+"_"+sGXsfl_34_idx, GetSecureSignedToken( sGXsfl_34_idx, context.localUtil.Format( (decimal)(A1PaisID), "ZZZZZ9"), context));
      }
      ...
      protected void STRUP030( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCpaisid_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCpaisid_Internalname), ".", ",") > Convert.ToDecimal( 999999 )) ) )
            {
               ...
               wbErr = true;
               AV6cPaisID = 0;
               AssignAttri("", false, "AV6cPaisID", StringUtil.LTrimStr( (decimal)(AV6cPaisID), 6, 0));
            }
            else
            {
               AV6cPaisID = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtavCpaisid_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV6cPaisID", StringUtil.LTrimStr( (decimal)(AV6cPaisID), 6, 0));
            }
      ...
      protected void E16032( )
      {
         ...
         AV8pPaisID = A1PaisID;
         AssignAttri("", false, "AV8pPaisID", StringUtil.LTrimStr( (decimal)(AV8pPaisID), 6, 0));
         context.setWebReturnParms(new Object[] {(int)AV8pPaisID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8pPaisID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV8pPaisID", StringUtil.LTrimStr( (decimal)(AV8pPaisID), 6, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522048491", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0010.js", "?2025522048491", false, true);
      ...
      protected void SubsflControlProps_342( )
      {
         ...
         edtPaisBandera_Internalname = "PAISBANDERA_"+sGXsfl_34_idx;
      }
      ...
      protected void SubsflControlProps_fel_342( )
      {
         ...
         edtPaisBandera_Internalname = "PAISBANDERA_"+sGXsfl_34_fel_idx;
      }
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisID), 6, 0, ".", "")))+"'"+"]);";
            ...
            edtPaisNombre_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisID), 6, 0, ".", "")))+"'"+"]);";
            ...
            Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisBandera_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn OptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A3PaisBandera_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
      ...
      protected void StartGridControl34( )
      {
         ...
         else
         {
            ...
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( A2PaisNombre));
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtPaisNombre_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", context.convertURL( A3PaisBandera));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cPaisID","fld":"vCPAISID","pic":"ZZZZZ9"},{"av":"AV7cPaisNombre","fld":"vCPAISNOMBRE"}]}""");
         ...
         setEventMetadata("LBLPAISIDFILTER.CLICK","""{"handler":"E11031","iparms":[{"av":"divPaisidfiltercontainer_Class","ctrl":"PAISIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLPAISNOMBREFILTER.CLICK","""{"handler":"E12031","iparms":[{"av":"divPaisnombrefiltercontainer_Class","ctrl":"PAISNOMBREFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E16032","iparms":[{"av":"A1PaisID","fld":"PAISID","pic":"ZZZZZ9","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV8pPaisID","fld":"vPPAISID","pic":"ZZZZZ9"}]}""");
         setEventMetadata("GRID1_FIRSTPAGE","""{"handler":"subgrid1_firstpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cPaisID","fld":"vCPAISID","pic":"ZZZZZ9"},{"av":"AV7cPaisNombre","fld":"vCPAISNOMBRE"}]}""");
         setEventMetadata("GRID1_PREVPAGE","""{"handler":"subgrid1_previouspage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cPaisID","fld":"vCPAISID","pic":"ZZZZZ9"},{"av":"AV7cPaisNombre","fld":"vCPAISNOMBRE"}]}""");
         setEventMetadata("GRID1_NEXTPAGE","""{"handler":"subgrid1_nextpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cPaisID","fld":"vCPAISID","pic":"ZZZZZ9"},{"av":"AV7cPaisNombre","fld":"vCPAISNOMBRE"}]}""");
         setEventMetadata("GRID1_LASTPAGE","""{"handler":"subgrid1_lastpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cPaisID","fld":"vCPAISID","pic":"ZZZZZ9"},{"av":"AV7cPaisNombre","fld":"vCPAISNOMBRE"}]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Paisbandera","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lV7cPaisNombre = "";
         H00032_A40000PaisBandera_GXI = new string[] {""} ;
         H00032_A2PaisNombre = new string[] {""} ;
         H00032_A1PaisID = new int[1] ;
         H00032_A3PaisBandera = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0010__default(),
            new Object[][] {
                new Object[] {
               H00032_A40000PaisBandera_GXI, H00032_A2PaisNombre, H00032_A1PaisID, H00032_A3PaisBandera
               }
               , new Object[] {
      ...
      private string[] H00032_A40000PaisBandera_GXI ;
      private string[] H00032_A2PaisNombre ;
      private int[] H00032_A1PaisID ;
      private string[] H00032_A3PaisBandera ;
      private long[] H00033_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private int aP0_pPaisID ;
   }
   ...
   public class gx0010__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00032(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] );
               case 1 :
                     return conditional_H00033(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6cPaisID",GXType.Int32,6,0) ,
          new ParDef("@lV7cPaisNombre",GXType.NVarChar,80,0) ,
