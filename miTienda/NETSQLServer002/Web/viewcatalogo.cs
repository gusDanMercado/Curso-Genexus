...
namespace GeneXus.Programs {
   public class viewcatalogo : GXDataArea
   {
      public viewcatalogo( )
      {
      ...
      public viewcatalogo( IGxContext context )
      {
      ...
      public void execute( int aP0_CatalogoID ,
                           string aP1_TabCode )
      {
         this.AV12CatalogoID = aP0_CatalogoID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12CatalogoID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12CatalogoID", StringUtil.LTrimStr( (decimal)(AV12CatalogoID), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vCATALOGOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CatalogoID), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewcatalogo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12CatalogoID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"CatalogoID","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vCATALOGOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12CatalogoID), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATALOGOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CatalogoID), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewCatalogo");
         forbiddenHiddens.Add("CatalogoDescripcion", StringUtil.RTrim( context.localUtil.Format( A29CatalogoDescripcion, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewcatalogo:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewcatalogo.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12CatalogoID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"CatalogoID","TabCode"})  ;
      }
      ...
      protected void WB0Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Catalogos", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewCatalogo.htm");
            ...
            GxWebStd.gx_label_element( context, edtCatalogoDescripcion_Internalname, "Descripcion", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtCatalogoDescripcion_Internalname, A29CatalogoDescripcion, StringUtil.RTrim( context.localUtil.Format( A29CatalogoDescripcion, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCatalogoDescripcion_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtCatalogoDescripcion_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "Descripcion", "start", true, "", "HLP_ViewCatalogo.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCatalogo.htm");
            /* Div Control */
      ...
      protected void START0Z2( )
      {
         ...
         Form.Meta.addItem("description", "View Catalogo", 0) ;
         context.wjLoc = "";
      ...
      protected void RF0Z2( )
      {
         ...
         {
            /* Using cursor H000Z2 */
            pr_default.execute(0, new Object[] {AV12CatalogoID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A28CatalogoID = H000Z2_A28CatalogoID[0];
               A29CatalogoDescripcion = H000Z2_A29CatalogoDescripcion[0];
      ...
      protected void STRUP0Z0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12CatalogoID = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vCATALOGOID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewcatalogo:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110Z2( )
      {
         ...
         AV14GXLvl7 = 0;
         /* Using cursor H000Z3 */
         pr_default.execute(1, new Object[] {AV12CatalogoID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A28CatalogoID = H000Z3_A28CatalogoID[0];
            A29CatalogoDescripcion = H000Z3_A29CatalogoDescripcion[0];
            AssignAttri("", false, "A29CatalogoDescripcion", A29CatalogoDescripcion);
            AV14GXLvl7 = 1;
            Form.Caption = A29CatalogoDescripcion;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwcatalogo.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "CatalogoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "catalogogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "CatalogoGeneral";
               WebComp_Generalwc_Component = "CatalogoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12CatalogoID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12CatalogoID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12CatalogoID", StringUtil.LTrimStr( (decimal)(AV12CatalogoID), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCATALOGOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CatalogoID), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522048545", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcatalogo.js", "?2025522048545", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12CatalogoID","fld":"vCATALOGOID","pic":"ZZZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A29CatalogoDescripcion","fld":"CATALOGODESCRIPCION"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000Z2_A28CatalogoID = new int[1] ;
         H000Z2_A29CatalogoDescripcion = new string[] {""} ;
         hsh = "";
         H000Z3_A28CatalogoID = new int[1] ;
         H000Z3_A29CatalogoDescripcion = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcatalogo__default(),
            new Object[][] {
                new Object[] {
               H000Z2_A28CatalogoID, H000Z2_A29CatalogoDescripcion
               }
               , new Object[] {
               H000Z3_A28CatalogoID, H000Z3_A29CatalogoDescripcion
               }
            }
         );
      ...
      private int AV12CatalogoID ;
      private int wcpOAV12CatalogoID ;
      ...
      private int[] H000Z2_A28CatalogoID ;
      private string[] H000Z2_A29CatalogoDescripcion ;
      private int[] H000Z3_A28CatalogoID ;
      private string[] H000Z3_A29CatalogoDescripcion ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewcatalogo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12CatalogoID",GXType.Int32,6,0)
          };
          Object[] prmH000Z3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000Z2", "SELECT [CatalogoID], [CatalogoDescripcion] FROM [Catalogo] WHERE [CatalogoID] = @AV12CatalogoID ORDER BY [CatalogoID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000Z3", "SELECT [CatalogoID], [CatalogoDescripcion] FROM [Catalogo] WHERE [CatalogoID] = @AV12CatalogoID ORDER BY [CatalogoID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Z3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
