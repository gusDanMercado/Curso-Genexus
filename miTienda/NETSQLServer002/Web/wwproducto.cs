...
namespace GeneXus.Programs {
   public class wwproducto : GXDataArea
   {
      public wwproducto( )
      {
      ...
      public wwproducto( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11ProductoNombre = GetPar( "ProductoNombre");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11ProductoNombre, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwproducto.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPRODUCTONOMBRE", AV11ProductoNombre);
         /* Send saved values. */
      ...
      {
         return formatLink("wwproducto.aspx")  ;
      }
      ...
      protected void WB0W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWProducto.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavProductonombre_Internalname, "Producto Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavProductonombre_Internalname, AV11ProductoNombre, StringUtil.RTrim( context.localUtil.Format( AV11ProductoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavProductonombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavProductonombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWProducto.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtProductoImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProductoImagen)) ? A40000ProductoImagen_GXI : context.convertURL( context.PathToRelativeUrl( A23ProductoImagen))), !bGXsfl_27_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Productonombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vPRODUCTONOMBRE"), AV11ProductoNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0W2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavProductonombre_Internalname;
      ...
      protected void RF0W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11ProductoNombre = StringUtil.Concat( StringUtil.RTrim( AV11ProductoNombre), "%", "");
            /* Using cursor H000W2 */
            pr_default.execute(0, new Object[] {lV11ProductoNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A27ProductoPaisNombre = H000W2_A27ProductoPaisNombre[0];
               A26ProductoPaisID = H000W2_A26ProductoPaisID[0];
               A5CategoriaNombre = H000W2_A5CategoriaNombre[0];
               A4CategoriaID = H000W2_A4CategoriaID[0];
               A7VendedorNombre = H000W2_A7VendedorNombre[0];
               A6VendedorID = H000W2_A6VendedorID[0];
               A40000ProductoImagen_GXI = H000W2_A40000ProductoImagen_GXI[0];
               AssignProp("", false, edtProductoImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProductoImagen)) ? A40000ProductoImagen_GXI : context.convertURL( context.PathToRelativeUrl( A23ProductoImagen))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtProductoImagen_Internalname, "SrcSet", context.GetImageSrcSet( A23ProductoImagen), true);
               A22ProductoPrecio = H000W2_A22ProductoPrecio[0];
               A21ProductoDescripcion = H000W2_A21ProductoDescripcion[0];
               A20ProductoNombre = H000W2_A20ProductoNombre[0];
               A19ProductoID = H000W2_A19ProductoID[0];
               A23ProductoImagen = H000W2_A23ProductoImagen[0];
               AssignProp("", false, edtProductoImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A23ProductoImagen)) ? A40000ProductoImagen_GXI : context.convertURL( context.PathToRelativeUrl( A23ProductoImagen))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtProductoImagen_Internalname, "SrcSet", context.GetImageSrcSet( A23ProductoImagen), true);
               A27ProductoPaisNombre = H000W2_A27ProductoPaisNombre[0];
               A5CategoriaNombre = H000W2_A5CategoriaNombre[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTOID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A19ProductoID), "ZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11ProductoNombre = StringUtil.Concat( StringUtil.RTrim( AV11ProductoNombre), "%", "");
         /* Using cursor H000W3 */
         pr_default.execute(1, new Object[] {lV11ProductoNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11ProductoNombre = GridState.FilterValues("Productonombre");
            AssignAttri("", false, "AV11ProductoNombre", AV11ProductoNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("ProductoNombre", AV11ProductoNombre);
      }
      ...
      protected void STRUP0W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11ProductoNombre = cgiGet( edtavProductonombre_Internalname);
            AssignAttri("", false, "AV11ProductoNombre", AV11ProductoNombre);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Producto";
      ...
      {
         edtProductoID_Internalname = "PRODUCTOID_"+sGXsfl_27_idx;
         edtProductoNombre_Internalname = "PRODUCTONOMBRE_"+sGXsfl_27_idx;
         edtProductoDescripcion_Internalname = "PRODUCTODESCRIPCION_"+sGXsfl_27_idx;
         edtProductoPrecio_Internalname = "PRODUCTOPRECIO_"+sGXsfl_27_idx;
         edtProductoImagen_Internalname = "PRODUCTOIMAGEN_"+sGXsfl_27_idx;
         edtVendedorID_Internalname = "VENDEDORID_"+sGXsfl_27_idx;
         edtVendedorNombre_Internalname = "VENDEDORNOMBRE_"+sGXsfl_27_idx;
         edtCategoriaID_Internalname = "CATEGORIAID_"+sGXsfl_27_idx;
         edtCategoriaNombre_Internalname = "CATEGORIANOMBRE_"+sGXsfl_27_idx;
         edtProductoPaisID_Internalname = "PRODUCTOPAISID_"+sGXsfl_27_idx;
         edtProductoPaisNombre_Internalname = "PRODUCTOPAISNOMBRE_"+sGXsfl_27_idx;
      ...
      {
         edtProductoID_Internalname = "PRODUCTOID_"+sGXsfl_27_fel_idx;
         edtProductoNombre_Internalname = "PRODUCTONOMBRE_"+sGXsfl_27_fel_idx;
         edtProductoDescripcion_Internalname = "PRODUCTODESCRIPCION_"+sGXsfl_27_fel_idx;
         edtProductoPrecio_Internalname = "PRODUCTOPRECIO_"+sGXsfl_27_fel_idx;
         edtProductoImagen_Internalname = "PRODUCTOIMAGEN_"+sGXsfl_27_fel_idx;
         edtVendedorID_Internalname = "VENDEDORID_"+sGXsfl_27_fel_idx;
         edtVendedorNombre_Internalname = "VENDEDORNOMBRE_"+sGXsfl_27_fel_idx;
         edtCategoriaID_Internalname = "CATEGORIAID_"+sGXsfl_27_fel_idx;
         edtCategoriaNombre_Internalname = "CATEGORIANOMBRE_"+sGXsfl_27_fel_idx;
         edtProductoPaisID_Internalname = "PRODUCTOPAISID_"+sGXsfl_27_fel_idx;
         edtProductoPaisNombre_Internalname = "PRODUCTOPAISNOMBRE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductoID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A19ProductoID), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A19ProductoID), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductoID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductoNombre_Internalname,(string)A20ProductoNombre,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtProductoNombre_Link,(string)"",(string)"",(string)"",(string)edtProductoNombre_Jsonclick,(short)0,(string)"attribute-description",(string)"",(string)ROClassString,(string)"column",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)80,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"Descripcion",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductoPrecio_Internalname,StringUtil.LTrim( StringUtil.NToC( A22ProductoPrecio, 10, 2, ".", "")),StringUtil.LTrim( context.localUtil.Format( A22ProductoPrecio, "ZZZZZZ9.99")),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductoPrecio_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"Precio",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVendedorID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A6VendedorID), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A6VendedorID), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtVendedorID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtVendedorNombre_Internalname,(string)A7VendedorNombre,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtVendedorNombre_Link,(string)"",(string)"",(string)"",(string)edtVendedorNombre_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)80,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"Descripcion",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriaID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A4CategoriaID), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A4CategoriaID), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCategoriaID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriaNombre_Internalname,(string)A5CategoriaNombre,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtCategoriaNombre_Link,(string)"",(string)"",(string)"",(string)edtCategoriaNombre_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)80,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"Descripcion",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtProductoPaisID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A26ProductoPaisID), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A26ProductoPaisID), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtProductoPaisID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 39,'',false,'" + sGXsfl_27_idx + "',27)\"";
      ...
      protected void init_default_properties( )
      {
         ...
         edtavProductonombre_Internalname = "vPRODUCTONOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtProductoNombre_Enabled = 0;
         edtProductoID_Enabled = 0;
         edtavProductonombre_Jsonclick = "";
         edtavProductonombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProductoNombre","fld":"vPRODUCTONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140W2","iparms":[{"av":"A19ProductoID","fld":"PRODUCTOID","pic":"ZZZZZ9","hsh":true},{"av":"A6VendedorID","fld":"VENDEDORID","pic":"ZZZZZ9"},{"av":"A4CategoriaID","fld":"CATEGORIAID","pic":"ZZZZZ9"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E110W2","iparms":[{"av":"A19ProductoID","fld":"PRODUCTOID","pic":"ZZZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProductoNombre","fld":"vPRODUCTONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProductoNombre","fld":"vPRODUCTONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProductoNombre","fld":"vPRODUCTONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ProductoNombre","fld":"vPRODUCTONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11ProductoNombre = "";
         H000W2_A27ProductoPaisNombre = new string[] {""} ;
         H000W2_A26ProductoPaisID = new int[1] ;
         H000W2_A5CategoriaNombre = new string[] {""} ;
         H000W2_A4CategoriaID = new int[1] ;
         H000W2_A7VendedorNombre = new string[] {""} ;
         H000W2_A6VendedorID = new int[1] ;
         H000W2_A40000ProductoImagen_GXI = new string[] {""} ;
         H000W2_A22ProductoPrecio = new decimal[1] ;
         H000W2_A21ProductoDescripcion = new string[] {""} ;
         H000W2_A20ProductoNombre = new string[] {""} ;
         H000W2_A19ProductoID = new int[1] ;
         H000W2_A23ProductoImagen = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwproducto__default(),
            new Object[][] {
                new Object[] {
               H000W2_A27ProductoPaisNombre, H000W2_A26ProductoPaisID, H000W2_A5CategoriaNombre, H000W2_A4CategoriaID, H000W2_A7VendedorNombre, H000W2_A6VendedorID, H000W2_A40000ProductoImagen_GXI, H000W2_A22ProductoPrecio, H000W2_A21ProductoDescripcion, H000W2_A20ProductoNombre,
               H000W2_A19ProductoID, H000W2_A23ProductoImagen
               }
               , new Object[] {
      ...
      private int edtavProductonombre_Enabled ;
      ...
      private string edtavProductonombre_Internalname ;
      private string edtavProductonombre_Jsonclick ;
      ...
      private string AV11ProductoNombre ;
      ...
      private string lV11ProductoNombre ;
      ...
      private string[] H000W2_A27ProductoPaisNombre ;
      private int[] H000W2_A26ProductoPaisID ;
      private string[] H000W2_A5CategoriaNombre ;
      private int[] H000W2_A4CategoriaID ;
      private string[] H000W2_A7VendedorNombre ;
      private int[] H000W2_A6VendedorID ;
      private string[] H000W2_A40000ProductoImagen_GXI ;
      private decimal[] H000W2_A22ProductoPrecio ;
      private string[] H000W2_A21ProductoDescripcion ;
      private string[] H000W2_A20ProductoNombre ;
      private int[] H000W2_A19ProductoID ;
      private string[] H000W2_A23ProductoImagen ;
   ...
   public class wwproducto__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A20ProductoNombre )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[PaisNombre] AS ProductoPaisNombre, T1.[ProductoPaisID] AS ProductoPaisID, T3.[CategoriaNombre], T1.[CategoriaID], T4.[VendedorNombre], T1.[VendedorID], T1.[ProductoImagen_GXI], T1.[ProductoPrecio], T1.[ProductoDescripcion], T1.[ProductoNombre], T1.[ProductoID], T1.[ProductoImagen]";
         sFromString = " FROM ((([Producto] T1 INNER JOIN [Pais] T2 ON T2.[PaisID] = T1.[ProductoPaisID]) INNER JOIN [Categoria] T3 ON T3.[CategoriaID] = T1.[CategoriaID]) INNER JOIN [Vendedor] T4 ON T4.[VendedorID] = T1.[VendedorID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ProductoNombre)) )
         {
            AddWhere(sWhereString, "(T1.[ProductoNombre] like @lV11ProductoNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[ProductoNombre]";
                                             ...
                                             string A20ProductoNombre )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((([Producto] T1 INNER JOIN [Pais] T4 ON T4.[PaisID] = T1.[ProductoPaisID]) INNER JOIN [Categoria] T3 ON T3.[CategoriaID] = T1.[CategoriaID]) INNER JOIN [Vendedor] T2 ON T2.[VendedorID] = T1.[VendedorID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ProductoNombre)) )
         {
            AddWhere(sWhereString, "(T1.[ProductoNombre] like @lV11ProductoNombre)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000W2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H000W3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11ProductoNombre",GXType.NVarChar,80,0) ,
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[11])[0] = rslt.getMultimediaFile(12, rslt.getVarchar(7));
                return;
             case 1 :
