   ...
   public class wwcatalogo : GXDataArea
   {
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Catalogoes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWCatalogo.htm");
      ...
      protected void START102( )
      {
         ...
         Form.Meta.addItem("description", "Catalogoes", 0) ;
         context.wjLoc = "";
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcatalogo.js", "?202552012694", false, true);
         }
