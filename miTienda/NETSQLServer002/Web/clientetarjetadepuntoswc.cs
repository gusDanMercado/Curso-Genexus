...
namespace GeneXus.Programs {
   public class clientetarjetadepuntoswc : GXWebComponent
   {
      public clientetarjetadepuntoswc( )
      {
      ...
      public clientetarjetadepuntoswc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6ClienteID = (int)(Math.Round(NumberUtil.Val( GetPar( "ClienteID"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV6ClienteID", StringUtil.LTrimStr( (decimal)(AV6ClienteID), 6, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV6ClienteID});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "ClienteTarjetaDePuntosWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Cliente Tarjeta De Puntos WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("clientetarjetadepuntoswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ClienteID,6,0))}, new string[] {"ClienteID"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6ClienteID", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6ClienteID), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ClienteID), 6, 0, ".", "")));
      ...
      {
         return "ClienteTarjetaDePuntosWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Cliente Tarjeta De Puntos WC" ;
      }
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "clientetarjetadepuntoswc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ClienteTarjetaDePuntosWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtClienteID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A9ClienteID), 6, 0, ".", "")), StringUtil.LTrim( ((edtClienteID_Enabled!=0) ? context.localUtil.Format( (decimal)(A9ClienteID), "ZZZZZ9") : context.localUtil.Format( (decimal)(A9ClienteID), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,31);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClienteID_Jsonclick, 0, "Attribute", "", "", "", "", edtClienteID_Visible, edtClienteID_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "ID", "end", false, "", "HLP_ClienteTarjetaDePuntosWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START1B2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Cliente Tarjeta De Puntos WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_TARJETADEPUNTOSID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A14TarjetaDePuntosID), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"TARJETADEPUNTOSID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A14TarjetaDePuntosID), 6, 0, ".", "")));
      }
      ...
      protected void RF1B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A9ClienteID = H001B2_A9ClienteID[0];
               AssignAttri(sPrefix, false, "A9ClienteID", StringUtil.LTrimStr( (decimal)(A9ClienteID), 6, 0));
               A16TarjetaDePuntosPuntos = H001B2_A16TarjetaDePuntosPuntos[0];
               A15TarjetaDePuntosStatus = H001B2_A15TarjetaDePuntosStatus[0];
               A14TarjetaDePuntosID = H001B2_A14TarjetaDePuntosID[0];
               /* Execute user event: Grid.Load */
               E131B2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_TARJETADEPUNTOSID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A14TarjetaDePuntosID), "ZZZZZ9"), context));
      }
      ...
      protected void STRUP1B0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6ClienteID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ClienteID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      private void E131B2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("tarjetadepuntos.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A14TarjetaDePuntosID,6,0))}, new string[] {"Mode","TarjetaDePuntosID"}) ;
         edtavDelete_Link = formatLink("tarjetadepuntos.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A14TarjetaDePuntosID,6,0))}, new string[] {"Mode","TarjetaDePuntosID"}) ;
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 22;
      ...
      protected void E111B2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("tarjetadepuntos.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","TarjetaDePuntosID"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "TarjetaDePuntos";
         ...
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6ClienteID), 6, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6ClienteID = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6ClienteID", StringUtil.LTrimStr( (decimal)(AV6ClienteID), 6, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "clientetarjetadepuntoswc", GetJustCreated( ));
         ...
         {
            AV6ClienteID = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6ClienteID", StringUtil.LTrimStr( (decimal)(AV6ClienteID), 6, 0));
         }
         wcpOAV6ClienteID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ClienteID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6ClienteID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6ClienteID), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6ClienteID", StringUtil.LTrimStr( (decimal)(AV6ClienteID), 6, 0));
         }
         else
         {
            AV6ClienteID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6ClienteID_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6ClienteID_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ClienteID), 6, 0, ".", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255220475947", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("clientetarjetadepuntoswc.js", "?20255220475947", false, true);
         }
      ...
      {
         edtTarjetaDePuntosID_Internalname = sPrefix+"TARJETADEPUNTOSID_"+sGXsfl_22_idx;
         cmbTarjetaDePuntosStatus_Internalname = sPrefix+"TARJETADEPUNTOSSTATUS_"+sGXsfl_22_idx;
         edtTarjetaDePuntosPuntos_Internalname = sPrefix+"TARJETADEPUNTOSPUNTOS_"+sGXsfl_22_idx;
      ...
      {
         edtTarjetaDePuntosID_Internalname = sPrefix+"TARJETADEPUNTOSID_"+sGXsfl_22_fel_idx;
         cmbTarjetaDePuntosStatus_Internalname = sPrefix+"TARJETADEPUNTOSSTATUS_"+sGXsfl_22_fel_idx;
         edtTarjetaDePuntosPuntos_Internalname = sPrefix+"TARJETADEPUNTOSPUNTOS_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTarjetaDePuntosID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A14TarjetaDePuntosID), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A14TarjetaDePuntosID), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTarjetaDePuntosID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            {
               GXCCtl = "TARJETADEPUNTOSSTATUS_" + sGXsfl_22_idx;
            ...
            /* ComboBox */
            GridRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbTarjetaDePuntosStatus,(string)cmbTarjetaDePuntosStatus_Internalname,StringUtil.RTrim( A15TarjetaDePuntosStatus),(short)1,(string)cmbTarjetaDePuntosStatus_Jsonclick,(short)0,(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"char",(string)"",(short)-1,(short)0,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"attribute-description",(string)"column",(string)"",(string)"",(string)"",(bool)true,(short)0});
            cmbTarjetaDePuntosStatus.CurrentValue = StringUtil.RTrim( A15TarjetaDePuntosStatus);
            AssignProp(sPrefix, false, cmbTarjetaDePuntosStatus_Internalname, "Values", (string)(cmbTarjetaDePuntosStatus.ToJavascriptSource()), !bGXsfl_22_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTarjetaDePuntosPuntos_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A16TarjetaDePuntosPuntos), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A16TarjetaDePuntosPuntos), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTarjetaDePuntosPuntos_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl22( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A14TarjetaDePuntosID), 6, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A15TarjetaDePuntosStatus)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A16TarjetaDePuntosPuntos), 6, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ClienteID","fld":"vCLIENTEID","pic":"ZZZZZ9"},{"av":"AV13Update","fld":"vUPDATE"},{"av":"AV14Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E131B2","iparms":[{"av":"A14TarjetaDePuntosID","fld":"TARJETADEPUNTOSID","pic":"ZZZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E111B2","iparms":[{"av":"A14TarjetaDePuntosID","fld":"TARJETADEPUNTOSID","pic":"ZZZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ClienteID","fld":"vCLIENTEID","pic":"ZZZZZ9"},{"av":"AV13Update","fld":"vUPDATE"},{"av":"AV14Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ClienteID","fld":"vCLIENTEID","pic":"ZZZZZ9"},{"av":"AV13Update","fld":"vUPDATE"},{"av":"AV14Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ClienteID","fld":"vCLIENTEID","pic":"ZZZZZ9"},{"av":"AV13Update","fld":"vUPDATE"},{"av":"AV14Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ClienteID","fld":"vCLIENTEID","pic":"ZZZZZ9"},{"av":"AV13Update","fld":"vUPDATE"},{"av":"AV14Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H001B2_A9ClienteID = new int[1] ;
         H001B2_A16TarjetaDePuntosPuntos = new int[1] ;
         H001B2_A15TarjetaDePuntosStatus = new string[] {""} ;
         H001B2_A14TarjetaDePuntosID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientetarjetadepuntoswc__default(),
            new Object[][] {
                new Object[] {
               H001B2_A9ClienteID, H001B2_A16TarjetaDePuntosPuntos, H001B2_A15TarjetaDePuntosStatus, H001B2_A14TarjetaDePuntosID
               }
               , new Object[] {
      ...
      private int AV6ClienteID ;
      private int wcpOAV6ClienteID ;
      ...
      private int[] H001B2_A9ClienteID ;
      private int[] H001B2_A16TarjetaDePuntosPuntos ;
      private string[] H001B2_A15TarjetaDePuntosStatus ;
      private int[] H001B2_A14TarjetaDePuntosID ;
   ...
   public class clientetarjetadepuntoswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6ClienteID",GXType.Int32,6,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001B2", "SELECT [ClienteID], [TarjetaDePuntosPuntos], [TarjetaDePuntosStatus], [TarjetaDePuntosID] FROM [TarjetaDePuntos] WHERE [ClienteID] = @AV6ClienteID ORDER BY [ClienteID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001B3", "SELECT COUNT(*) FROM [TarjetaDePuntos] WHERE [ClienteID] = @AV6ClienteID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
