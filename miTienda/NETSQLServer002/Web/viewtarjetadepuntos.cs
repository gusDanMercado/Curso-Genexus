...
namespace GeneXus.Programs {
   public class viewtarjetadepuntos : GXDataArea
   {
      public viewtarjetadepuntos( )
      {
      ...
      public viewtarjetadepuntos( IGxContext context )
      {
      ...
      public void execute( int aP0_TarjetaDePuntosID ,
                           string aP1_TabCode )
      {
         this.AV12TarjetaDePuntosID = aP0_TarjetaDePuntosID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12TarjetaDePuntosID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12TarjetaDePuntosID", StringUtil.LTrimStr( (decimal)(AV12TarjetaDePuntosID), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vTARJETADEPUNTOSID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12TarjetaDePuntosID), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewtarjetadepuntos.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12TarjetaDePuntosID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"TarjetaDePuntosID","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vTARJETADEPUNTOSID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12TarjetaDePuntosID), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vTARJETADEPUNTOSID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12TarjetaDePuntosID), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewTarjetaDePuntos");
         forbiddenHiddens.Add("TarjetaDePuntosStatus", StringUtil.RTrim( context.localUtil.Format( A15TarjetaDePuntosStatus, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewtarjetadepuntos:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewtarjetadepuntos.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12TarjetaDePuntosID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"TarjetaDePuntosID","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ViewTarjetaDePuntos" ;
      }

      public override string GetPgmdesc( )
      {
         return "View Tarjeta De Puntos" ;
      }
      ...
      protected void WB1E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Tarjeta De Puntos", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewTarjetaDePuntos.htm");
            ...
            GxWebStd.gx_label_element( context, cmbTarjetaDePuntosStatus_Internalname, "Puntos Status", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbTarjetaDePuntosStatus, cmbTarjetaDePuntosStatus_Internalname, StringUtil.RTrim( A15TarjetaDePuntosStatus), 1, cmbTarjetaDePuntosStatus_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbTarjetaDePuntosStatus.Enabled, 0, 0, 0, "em", 0, "", "", "heading-01", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "", true, 0, "HLP_ViewTarjetaDePuntos.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewTarjetaDePuntos.htm");
            /* Div Control */
      ...
      protected void START1E2( )
      {
         ...
         Form.Meta.addItem("description", "View Tarjeta De Puntos", 0) ;
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV13Pgmname = "ViewTarjetaDePuntos";
      }
      ...
      protected void RF1E2( )
      {
         ...
         {
            /* Using cursor H001E2 */
            pr_default.execute(0, new Object[] {AV12TarjetaDePuntosID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A14TarjetaDePuntosID = H001E2_A14TarjetaDePuntosID[0];
               A15TarjetaDePuntosStatus = H001E2_A15TarjetaDePuntosStatus[0];
               AssignAttri("", false, "A15TarjetaDePuntosStatus", A15TarjetaDePuntosStatus);
               /* Execute user event: Load */
               E121E2 ();
      ...
      protected void STRUP1E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12TarjetaDePuntosID = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vTARJETADEPUNTOSID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewtarjetadepuntos:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E111E2( )
      {
         ...
         AV14GXLvl7 = 0;
         /* Using cursor H001E3 */
         pr_default.execute(1, new Object[] {AV12TarjetaDePuntosID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A14TarjetaDePuntosID = H001E3_A14TarjetaDePuntosID[0];
            A15TarjetaDePuntosStatus = H001E3_A15TarjetaDePuntosStatus[0];
            AssignAttri("", false, "A15TarjetaDePuntosStatus", A15TarjetaDePuntosStatus);
            AV14GXLvl7 = 1;
            Form.Caption = A15TarjetaDePuntosStatus;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwtarjetadepuntos.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "TarjetaDePuntosGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "tarjetadepuntosgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "TarjetaDePuntosGeneral";
               WebComp_Generalwc_Component = "TarjetaDePuntosGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12TarjetaDePuntosID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12TarjetaDePuntosID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12TarjetaDePuntosID", StringUtil.LTrimStr( (decimal)(AV12TarjetaDePuntosID), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vTARJETADEPUNTOSID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12TarjetaDePuntosID), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522048481", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewtarjetadepuntos.js", "?2025522048481", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Tarjeta De Puntos";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12TarjetaDePuntosID","fld":"vTARJETADEPUNTOSID","pic":"ZZZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"cmbTarjetaDePuntosStatus"},{"av":"A15TarjetaDePuntosStatus","fld":"TARJETADEPUNTOSSTATUS"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H001E2_A14TarjetaDePuntosID = new int[1] ;
         H001E2_A15TarjetaDePuntosStatus = new string[] {""} ;
         hsh = "";
         H001E3_A14TarjetaDePuntosID = new int[1] ;
         H001E3_A15TarjetaDePuntosStatus = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewtarjetadepuntos__default(),
            new Object[][] {
                new Object[] {
               H001E2_A14TarjetaDePuntosID, H001E2_A15TarjetaDePuntosStatus
               }
               , new Object[] {
               H001E3_A14TarjetaDePuntosID, H001E3_A15TarjetaDePuntosStatus
               }
            }
         );
      ...
      private int AV12TarjetaDePuntosID ;
      private int wcpOAV12TarjetaDePuntosID ;
      ...
      private int[] H001E2_A14TarjetaDePuntosID ;
      private string[] H001E2_A15TarjetaDePuntosStatus ;
      private int[] H001E3_A14TarjetaDePuntosID ;
      private string[] H001E3_A15TarjetaDePuntosStatus ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewtarjetadepuntos__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12TarjetaDePuntosID",GXType.Int32,6,0)
          };
          Object[] prmH001E3;
          ...
          def= new CursorDef[] {
              new CursorDef("H001E2", "SELECT [TarjetaDePuntosID], [TarjetaDePuntosStatus] FROM [TarjetaDePuntos] WHERE [TarjetaDePuntosID] = @AV12TarjetaDePuntosID ORDER BY [TarjetaDePuntosID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H001E3", "SELECT [TarjetaDePuntosID], [TarjetaDePuntosStatus] FROM [TarjetaDePuntos] WHERE [TarjetaDePuntosID] = @AV12TarjetaDePuntosID ORDER BY [TarjetaDePuntosID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001E3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
