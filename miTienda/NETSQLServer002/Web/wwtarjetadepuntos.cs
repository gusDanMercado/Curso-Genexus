...
namespace GeneXus.Programs {
   public class wwtarjetadepuntos : GXDataArea
   {
      public wwtarjetadepuntos( )
      {
      ...
      public wwtarjetadepuntos( IGxContext context )
      {
      ...
      {
         cmbavTarjetadepuntosstatus = new GXCombobox();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         cmbavTarjetadepuntosstatus.FromJSonString( GetNextPar( ));
         AV11TarjetaDePuntosStatus = GetPar( "TarjetaDePuntosStatus");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11TarjetaDePuntosStatus) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwtarjetadepuntos.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vTARJETADEPUNTOSSTATUS", StringUtil.RTrim( AV11TarjetaDePuntosStatus));
         /* Send saved values. */
      ...
      {
         return formatLink("wwtarjetadepuntos.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WWTarjetaDePuntos" ;
      }
      ...
      protected void WB1C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, cmbavTarjetadepuntosstatus_Internalname, "Tarjeta De Puntos Status", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 14,'',false,'" + sGXsfl_23_idx + "',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavTarjetadepuntosstatus, cmbavTarjetadepuntosstatus_Internalname, StringUtil.RTrim( AV11TarjetaDePuntosStatus), 1, cmbavTarjetadepuntosstatus_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavTarjetadepuntosstatus.Enabled, 0, 0, 0, "em", 0, "", "", "attribute-search", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "", true, 0, "HLP_WWTarjetaDePuntos.htm");
            cmbavTarjetadepuntosstatus.CurrentValue = StringUtil.RTrim( AV11TarjetaDePuntosStatus);
            AssignProp("", false, cmbavTarjetadepuntosstatus_Internalname, "Values", (string)(cmbavTarjetadepuntosstatus.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Tarjetadepuntosstatus Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vTARJETADEPUNTOSSTATUS"), AV11TarjetaDePuntosStatus) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA1C2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = cmbavTarjetadepuntosstatus_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       string AV11TarjetaDePuntosStatus )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      {
         if ( cmbavTarjetadepuntosstatus.ItemCount > 0 )
         {
            AV11TarjetaDePuntosStatus = cmbavTarjetadepuntosstatus.getValidValue(AV11TarjetaDePuntosStatus);
            AssignAttri("", false, "AV11TarjetaDePuntosStatus", AV11TarjetaDePuntosStatus);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavTarjetadepuntosstatus.CurrentValue = StringUtil.RTrim( AV11TarjetaDePuntosStatus);
            AssignProp("", false, cmbavTarjetadepuntosstatus_Internalname, "Values", cmbavTarjetadepuntosstatus.ToJavascriptSource(), true);
         }
      }
      ...
      protected void RF1C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11TarjetaDePuntosStatus = StringUtil.PadR( StringUtil.RTrim( AV11TarjetaDePuntosStatus), 1, "%");
            /* Using cursor H001C2 */
            pr_default.execute(0, new Object[] {lV11TarjetaDePuntosStatus, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_23_idx = 1;
            sGXsfl_23_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_23_idx), 4, 0), 4, "0");
            SubsflControlProps_232( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A10ClienteNombre = H001C2_A10ClienteNombre[0];
               A9ClienteID = H001C2_A9ClienteID[0];
               A16TarjetaDePuntosPuntos = H001C2_A16TarjetaDePuntosPuntos[0];
               A15TarjetaDePuntosStatus = H001C2_A15TarjetaDePuntosStatus[0];
               A14TarjetaDePuntosID = H001C2_A14TarjetaDePuntosID[0];
               A10ClienteNombre = H001C2_A10ClienteNombre[0];
               /* Execute user event: Grid.Load */
               E131C2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11TarjetaDePuntosStatus = StringUtil.PadR( StringUtil.RTrim( AV11TarjetaDePuntosStatus), 1, "%");
         /* Using cursor H001C3 */
         pr_default.execute(1, new Object[] {lV11TarjetaDePuntosStatus});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11TarjetaDePuntosStatus = GridState.FilterValues("Tarjetadepuntosstatus");
            AssignAttri("", false, "AV11TarjetaDePuntosStatus", AV11TarjetaDePuntosStatus);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("TarjetaDePuntosStatus", AV11TarjetaDePuntosStatus);
      }
      ...
      protected void STRUP1C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            cmbavTarjetadepuntosstatus.Name = cmbavTarjetadepuntosstatus_Internalname;
            cmbavTarjetadepuntosstatus.CurrentValue = cgiGet( cmbavTarjetadepuntosstatus_Internalname);
            AV11TarjetaDePuntosStatus = cgiGet( cmbavTarjetadepuntosstatus_Internalname);
            AssignAttri("", false, "AV11TarjetaDePuntosStatus", AV11TarjetaDePuntosStatus);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "TarjetaDePuntos";
      ...
      {
         edtTarjetaDePuntosID_Internalname = "TARJETADEPUNTOSID_"+sGXsfl_23_idx;
         cmbTarjetaDePuntosStatus_Internalname = "TARJETADEPUNTOSSTATUS_"+sGXsfl_23_idx;
         edtTarjetaDePuntosPuntos_Internalname = "TARJETADEPUNTOSPUNTOS_"+sGXsfl_23_idx;
         edtClienteID_Internalname = "CLIENTEID_"+sGXsfl_23_idx;
         edtClienteNombre_Internalname = "CLIENTENOMBRE_"+sGXsfl_23_idx;
      }

      protected void SubsflControlProps_fel_232( )
      {
         edtTarjetaDePuntosID_Internalname = "TARJETADEPUNTOSID_"+sGXsfl_23_fel_idx;
         cmbTarjetaDePuntosStatus_Internalname = "TARJETADEPUNTOSSTATUS_"+sGXsfl_23_fel_idx;
         edtTarjetaDePuntosPuntos_Internalname = "TARJETADEPUNTOSPUNTOS_"+sGXsfl_23_fel_idx;
         edtClienteID_Internalname = "CLIENTEID_"+sGXsfl_23_fel_idx;
         edtClienteNombre_Internalname = "CLIENTENOMBRE_"+sGXsfl_23_fel_idx;
      }
      ...
      protected void sendrow_232( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_23_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTarjetaDePuntosID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A14TarjetaDePuntosID), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A14TarjetaDePuntosID), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTarjetaDePuntosID_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)23,(short)0,(short)-1,(short)0,(bool)true,(string)"ID",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            {
               GXCCtl = "TARJETADEPUNTOSSTATUS_" + sGXsfl_23_idx;
            ...
            AssignProp("", false, cmbTarjetaDePuntosStatus_Internalname, "Values", (string)(cmbTarjetaDePuntosStatus.ToJavascriptSource()), !bGXsfl_23_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTarjetaDePuntosPuntos_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A16TarjetaDePuntosPuntos), 6, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A16TarjetaDePuntosPuntos), "ZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTarjetaDePuntosPuntos_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)6,(short)0,(short)0,(short)23,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      {
         cmbavTarjetadepuntosstatus.Name = "vTARJETADEPUNTOSSTATUS";
         cmbavTarjetadepuntosstatus.WebTags = "";
         cmbavTarjetadepuntosstatus.addItem("", "(All)", 0);
         cmbavTarjetadepuntosstatus.addItem("N", "Normal", 0);
         cmbavTarjetadepuntosstatus.addItem("V", "Vip", 0);
         if ( cmbavTarjetadepuntosstatus.ItemCount > 0 )
         {
            AV11TarjetaDePuntosStatus = cmbavTarjetadepuntosstatus.getValidValue(AV11TarjetaDePuntosStatus);
            AssignAttri("", false, "AV11TarjetaDePuntosStatus", AV11TarjetaDePuntosStatus);
      ...
      protected void init_default_properties( )
      {
         ...
         cmbavTarjetadepuntosstatus_Internalname = "vTARJETADEPUNTOSSTATUS";
      ...
      public override void initialize_properties( )
      {
         ...
         cmbTarjetaDePuntosStatus.Enabled = 0;
         edtTarjetaDePuntosID_Enabled = 0;
         cmbavTarjetadepuntosstatus_Jsonclick = "";
         cmbavTarjetadepuntosstatus.Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"cmbavTarjetadepuntosstatus"},{"av":"AV11TarjetaDePuntosStatus","fld":"vTARJETADEPUNTOSSTATUS"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E131C2","iparms":[{"av":"A9ClienteID","fld":"CLIENTEID","pic":"ZZZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtClienteNombre_Link","ctrl":"CLIENTENOMBRE","prop":"Link"}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"cmbavTarjetadepuntosstatus"},{"av":"AV11TarjetaDePuntosStatus","fld":"vTARJETADEPUNTOSSTATUS"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"cmbavTarjetadepuntosstatus"},{"av":"AV11TarjetaDePuntosStatus","fld":"vTARJETADEPUNTOSSTATUS"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"cmbavTarjetadepuntosstatus"},{"av":"AV11TarjetaDePuntosStatus","fld":"vTARJETADEPUNTOSSTATUS"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"cmbavTarjetadepuntosstatus"},{"av":"AV11TarjetaDePuntosStatus","fld":"vTARJETADEPUNTOSSTATUS"}]}""");
         setEventMetadata("VALIDV_TARJETADEPUNTOSSTATUS","""{"handler":"Validv_Tarjetadepuntosstatus","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11TarjetaDePuntosStatus = "";
         H001C2_A10ClienteNombre = new string[] {""} ;
         H001C2_A9ClienteID = new int[1] ;
         H001C2_A16TarjetaDePuntosPuntos = new int[1] ;
         H001C2_A15TarjetaDePuntosStatus = new string[] {""} ;
         H001C2_A14TarjetaDePuntosID = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwtarjetadepuntos__default(),
            new Object[][] {
                new Object[] {
               H001C2_A10ClienteNombre, H001C2_A9ClienteID, H001C2_A16TarjetaDePuntosPuntos, H001C2_A15TarjetaDePuntosStatus, H001C2_A14TarjetaDePuntosID
               }
               , new Object[] {
      ...
      private string AV11TarjetaDePuntosStatus ;
      ...
      private string cmbavTarjetadepuntosstatus_Internalname ;
      private string TempTags ;
      private string cmbavTarjetadepuntosstatus_Jsonclick ;
      ...
      private string lV11TarjetaDePuntosStatus ;
      ...
      private GXCombobox cmbavTarjetadepuntosstatus ;
      private GXCombobox cmbTarjetaDePuntosStatus ;
      private IDataStoreProvider pr_default ;
      private string[] H001C2_A10ClienteNombre ;
      private int[] H001C2_A9ClienteID ;
      private int[] H001C2_A16TarjetaDePuntosPuntos ;
      private string[] H001C2_A15TarjetaDePuntosStatus ;
      private int[] H001C2_A14TarjetaDePuntosID ;
   ...
   public class wwtarjetadepuntos__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A15TarjetaDePuntosStatus )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[ClienteNombre], T1.[ClienteID], T1.[TarjetaDePuntosPuntos], T1.[TarjetaDePuntosStatus], T1.[TarjetaDePuntosID]";
         sFromString = " FROM ([TarjetaDePuntos] T1 INNER JOIN [Cliente] T2 ON T2.[ClienteID] = T1.[ClienteID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11TarjetaDePuntosStatus)) )
         {
            AddWhere(sWhereString, "(T1.[TarjetaDePuntosStatus] like @lV11TarjetaDePuntosStatus)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[TarjetaDePuntosStatus]";
                                             ...
                                             string A15TarjetaDePuntosStatus )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([TarjetaDePuntos] T1 INNER JOIN [Cliente] T2 ON T2.[ClienteID] = T1.[ClienteID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11TarjetaDePuntosStatus)) )
         {
            AddWhere(sWhereString, "(T1.[TarjetaDePuntosStatus] like @lV11TarjetaDePuntosStatus)");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001C2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H001C3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11TarjetaDePuntosStatus",GXType.NChar,1,0) ,
