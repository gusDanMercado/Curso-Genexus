...
namespace GeneXus.Programs {
   public class viewproveedor : GXDataArea
   {
      ...
      public viewproveedor( IGxContext context )
      {
      ...
      public void execute( int aP0_ProveedorID ,
                           string aP1_TabCode )
      {
         this.AV12ProveedorID = aP0_ProveedorID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12ProveedorID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12ProveedorID", StringUtil.LTrimStr( (decimal)(AV12ProveedorID), 6, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vPROVEEDORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProveedorID), "ZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewproveedor.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProveedorID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProveedorID","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vPROVEEDORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12ProveedorID), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPROVEEDORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProveedorID), "ZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewProveedor");
         forbiddenHiddens.Add("ProveedorNombre", StringUtil.RTrim( context.localUtil.Format( A18ProveedorNombre, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewproveedor:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewproveedor.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12ProveedorID,6,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"ProveedorID","TabCode"})  ;
      }
      ...
      protected void WB0O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Proveedores", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewProveedor.htm");
            ...
            GxWebStd.gx_label_element( context, edtProveedorNombre_Internalname, "Nombre", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 15,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtProveedorNombre_Internalname, A18ProveedorNombre, StringUtil.RTrim( context.localUtil.Format( A18ProveedorNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProveedorNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtProveedorNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "Descripcion", "start", true, "", "HLP_ViewProveedor.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewProveedor.htm");
            /* Div Control */
      ...
      protected void START0O2( )
      {
         ...
         Form.Meta.addItem("description", "View Proveedor", 0) ;
         context.wjLoc = "";
      ...
      protected void RF0O2( )
      {
         ...
         {
            /* Using cursor H000O2 */
            pr_default.execute(0, new Object[] {AV12ProveedorID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A17ProveedorID = H000O2_A17ProveedorID[0];
               A18ProveedorNombre = H000O2_A18ProveedorNombre[0];
      ...
      protected void STRUP0O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12ProveedorID = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vPROVEEDORID"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewproveedor:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110O2( )
      {
         ...
         AV14GXLvl7 = 0;
         /* Using cursor H000O3 */
         pr_default.execute(1, new Object[] {AV12ProveedorID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A17ProveedorID = H000O3_A17ProveedorID[0];
            A18ProveedorNombre = H000O3_A18ProveedorNombre[0];
            AssignAttri("", false, "A18ProveedorNombre", A18ProveedorNombre);
            AV14GXLvl7 = 1;
            Form.Caption = A18ProveedorNombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwproveedor.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ProveedorGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "proveedorgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ProveedorGeneral";
               WebComp_Generalwc_Component = "ProveedorGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(int)AV12ProveedorID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12ProveedorID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV12ProveedorID", StringUtil.LTrimStr( (decimal)(AV12ProveedorID), 6, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPROVEEDORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12ProveedorID), "ZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2025522048346", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewproveedor.js", "?2025522048346", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12ProveedorID","fld":"vPROVEEDORID","pic":"ZZZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A18ProveedorNombre","fld":"PROVEEDORNOMBRE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000O2_A17ProveedorID = new int[1] ;
         H000O2_A18ProveedorNombre = new string[] {""} ;
         hsh = "";
         H000O3_A17ProveedorID = new int[1] ;
         H000O3_A18ProveedorNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewproveedor__default(),
            new Object[][] {
                new Object[] {
               H000O2_A17ProveedorID, H000O2_A18ProveedorNombre
               }
               , new Object[] {
               H000O3_A17ProveedorID, H000O3_A18ProveedorNombre
               }
            }
         );
      ...
      private int AV12ProveedorID ;
      private int wcpOAV12ProveedorID ;
      ...
      private int[] H000O2_A17ProveedorID ;
      private string[] H000O2_A18ProveedorNombre ;
      private int[] H000O3_A17ProveedorID ;
      private string[] H000O3_A18ProveedorNombre ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewproveedor__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12ProveedorID",GXType.Int32,6,0)
          };
          Object[] prmH000O3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000O2", "SELECT [ProveedorID], [ProveedorNombre] FROM [Proveedor] WHERE [ProveedorID] = @AV12ProveedorID ORDER BY [ProveedorID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000O2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000O3", "SELECT [ProveedorID], [ProveedorNombre] FROM [Proveedor] WHERE [ProveedorID] = @AV12ProveedorID ORDER BY [ProveedorID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000O3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
