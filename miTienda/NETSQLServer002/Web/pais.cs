   ...
   public class pais : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV7PaisID = (int)(Math.Round(NumberUtil.Val( GetPar( "PaisID"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtPaisID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1PaisID), 6, 0, ".", "")), StringUtil.LTrim( ((edtPaisID_Enabled!=0) ? context.localUtil.Format( (decimal)(A1PaisID), "ZZZZZ9") : context.localUtil.Format( (decimal)(A1PaisID), "ZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisID_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPaisID_Enabled, 0, "text", "1", 6, "chr", 1, "row", 6, 0, 0, 0, 0, -1, 0, true, "ID", "end", false, "", "HLP_Pais.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPaisNombre_Internalname, A2PaisNombre, StringUtil.RTrim( context.localUtil.Format( A2PaisNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "Descripcion", "start", true, "", "HLP_Pais.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, "", "Bandera", "col-sm-3 ImageLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
         ...
         GxWebStd.gx_bitmap( context, imgPaisBandera_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, imgPaisBandera_Enabled, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "", "", "", 0, A3PaisBandera_IsBlob, true, context.GetImageSrcSet( sImgUrl), "HLP_Pais.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Gx_mode = cgiGet( "Mode");
               AV7PaisID = (int)(Math.Round(context.localUtil.CToN( cgiGet( "vPAISID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void Load011( )
      {
         ...
         if ( (pr_default.getStatus(2) != 101) )
         {
            ...
            A3PaisBandera = T00014_A3PaisBandera[0];
            AssignAttri("", false, "A3PaisBandera", A3PaisBandera);
            AssignProp("", false, imgPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), true);
            AssignProp("", false, imgPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandera), true);
            ZM011( -4) ;
      ...
      protected void CheckExtendedTable011( )
      {
         ...
         {
            GX_msglist.addItem("Error, El nombre del Pais es obligatorio!!!", 1, "PAISNOMBRE");
            AnyError = 1;
            GX_FocusControl = edtPaisNombre_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignProp("", false, imgPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), true);
            AssignProp("", false, imgPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandera), true);
            A3PaisBandera = T00013_A3PaisBandera[0];
            AssignAttri("", false, "A3PaisBandera", A3PaisBandera);
            AssignProp("", false, imgPaisBandera_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A3PaisBandera)) ? A40000PaisBandera_GXI : context.convertURL( context.PathToRelativeUrl( A3PaisBandera))), true);
            AssignProp("", false, imgPaisBandera_Internalname, "SrcSet", context.GetImageSrcSet( A3PaisBandera), true);
            Z1PaisID = A1PaisID;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z2PaisNombre", Z2PaisNombre);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255220475869", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("pais.js", "?20255220475869", false, true);
      ...
      public void Valid_Paisnombre( )
      {
         ...
         pr_default.execute(15, new Object[] {A2PaisNombre, A1PaisID});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV9TrnContext","fld":"vTRNCONTEXT","hsh":true},{"av":"AV7PaisID","fld":"vPAISID","pic":"ZZZZZ9","hsh":true},{"av":"A1PaisID","fld":"PAISID","pic":"ZZZZZ9"}]}""");
         ...
         setEventMetadata("VALID_PAISNOMBRE","""{"handler":"Valid_Paisnombre","iparms":[{"av":"A2PaisNombre","fld":"PAISNOMBRE"},{"av":"A1PaisID","fld":"PAISID","pic":"ZZZZZ9"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         T00016_A1PaisID = new int[1] ;
         T00013_A1PaisID = new int[1] ;
         T00013_A2PaisNombre = new string[] {""} ;
         T00013_A40000PaisBandera_GXI = new string[] {""} ;
         T00013_A3PaisBandera = new string[] {""} ;
         T00017_A1PaisID = new int[1] ;
         T00018_A1PaisID = new int[1] ;
         T00012_A1PaisID = new int[1] ;
         T00012_A2PaisNombre = new string[] {""} ;
         T00012_A40000PaisBandera_GXI = new string[] {""} ;
         T00012_A3PaisBandera = new string[] {""} ;
         T00019_A1PaisID = new int[1] ;
         T000113_A19ProductoID = new int[1] ;
         T000114_A9ClienteID = new int[1] ;
         T000115_A6VendedorID = new int[1] ;
         T000116_A1PaisID = new int[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXCCtlgxBlob = "";
         T000117_A2PaisNombre = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pais__default(),
            new Object[][] {
                new Object[] {
               T00012_A1PaisID, T00012_A2PaisNombre, T00012_A40000PaisBandera_GXI, T00012_A3PaisBandera
               }
               , new Object[] {
               T00013_A1PaisID, T00013_A2PaisNombre, T00013_A40000PaisBandera_GXI, T00013_A3PaisBandera
               }
               , new Object[] {
               ...
               , new Object[] {
               T000113_A19ProductoID
               }
               , new Object[] {
               T000114_A9ClienteID
               }
               , new Object[] {
               T000115_A6VendedorID
               }
               , new Object[] {
               T000116_A1PaisID
               }
               , new Object[] {
               T000117_A2PaisNombre
               }
            }
         );
         Z1PaisID = 1;
      ...
      private int[] T00016_A1PaisID ;
      private int[] T00013_A1PaisID ;
      private string[] T00013_A2PaisNombre ;
      private string[] T00013_A40000PaisBandera_GXI ;
      private string[] T00013_A3PaisBandera ;
      private int[] T00017_A1PaisID ;
      private int[] T00018_A1PaisID ;
      private int[] T00012_A1PaisID ;
      private string[] T00012_A2PaisNombre ;
      private string[] T00012_A40000PaisBandera_GXI ;
      private string[] T00012_A3PaisBandera ;
      private int[] T00019_A1PaisID ;
      private int[] T000113_A19ProductoID ;
      private int[] T000114_A9ClienteID ;
      private int[] T000115_A6VendedorID ;
      private int[] T000116_A1PaisID ;
      private string[] T000117_A2PaisNombre ;
   }
   ...
   public class pais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T00012", "SELECT [PaisID], [PaisNombre], [PaisBandera_GXI], [PaisBandera] FROM [Pais] WITH (UPDLOCK) WHERE [PaisID] = @PaisID ",true, GxErrorMask.GX_NOMASK, false, this,prmT00012,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00013", "SELECT [PaisID], [PaisNombre], [PaisBandera_GXI], [PaisBandera] FROM [Pais] WHERE [PaisID] = @PaisID ",true, GxErrorMask.GX_NOMASK, false, this,prmT00013,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00014", "SELECT TM1.[PaisID], TM1.[PaisNombre], TM1.[PaisBandera_GXI], TM1.[PaisBandera] FROM [Pais] TM1 WHERE TM1.[PaisID] = @PaisID ORDER BY TM1.[PaisID]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT00014,100, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T00019", "INSERT INTO [Pais]([PaisNombre], [PaisBandera], [PaisBandera_GXI]) VALUES(@PaisNombre, @PaisBandera, @PaisBandera_GXI); SELECT SCOPE_IDENTITY()",true, GxErrorMask.GX_NOMASK, false, this,prmT00019,1, GxCacheFrequency.OFF ,true,true )
             ...
             ,new CursorDef("T000113", "SELECT TOP 1 [ProductoID] FROM [Producto] WHERE [ProductoPaisID] = @PaisID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000113,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000114", "SELECT TOP 1 [ClienteID] FROM [Cliente] WHERE [PaisID] = @PaisID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000114,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000115", "SELECT TOP 1 [VendedorID] FROM [Vendedor] WHERE [PaisID] = @PaisID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000115,1, GxCacheFrequency.OFF ,true,true )
             ...
             ,new CursorDef("T000117", "SELECT [PaisNombre] FROM [Pais] WHERE ([PaisNombre] = @PaisNombre) AND (Not ( [PaisID] = @PaisID)) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000117,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
