...
CREATE NONCLUSTERED INDEX [IPRODUCTO3] ON [Producto] ([PaisIDProducto] );
...
ALTER TABLE [Producto] ADD CONSTRAINT [IPRODUCTO3] FOREIGN KEY ([PaisIDProducto]) REFERENCES [Pais] ([PaisID]);
