...
namespace GeneXus.Programs.general.security {
   public class notauthorized : GXDataArea
   {
      ...
      protected void wb_table1_3_0A2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_12_0A2( true) ;
         }
         else
         {
            wb_table2_12_0A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_12_0A2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_15_0A2( true) ;
         }
         else
         {
            wb_table3_15_0A2( false) ;
         }
         return  ;
      }

      protected void wb_table3_15_0A2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_15_0A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_15_0A2e( true) ;
         }
         else
         {
            wb_table3_15_0A2e( false) ;
         }
      }

      protected void wb_table2_12_0A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_12_0A2e( true) ;
         }
         else
         {
            wb_table2_12_0A2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541223451642", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/security/notauthorized.js", "?202541223451642", false, true);
