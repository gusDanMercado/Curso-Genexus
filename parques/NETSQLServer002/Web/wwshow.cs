...
namespace GeneXus.Programs {
   public class wwshow : GXDataArea
   {
      public wwshow( )
      {
      ...
      public wwshow( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11ShowNombre = GetPar( "ShowNombre");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11ShowNombre, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwshow.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vSHOWNOMBRE", AV11ShowNombre);
         /* Send saved values. */
      ...
      protected void WB0V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Shows", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWShow.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWShow.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavShownombre_Internalname, "Show Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavShownombre_Internalname, AV11ShowNombre, StringUtil.RTrim( context.localUtil.Format( AV11ShowNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavShownombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavShownombre_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWShow.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0V2( )
      {
         ...
         Form.Meta.addItem("description", "Shows", 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtShowImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A22ShowImagen)) ? A40000ShowImagen_GXI : context.convertURL( context.PathToRelativeUrl( A22ShowImagen))), !bGXsfl_27_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Shownombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vSHOWNOMBRE"), AV11ShowNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0V2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavShownombre_Internalname;
      ...
      protected void RF0V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11ShowNombre = StringUtil.Concat( StringUtil.RTrim( AV11ShowNombre), "%", "");
            /* Using cursor H000V2 */
            pr_default.execute(0, new Object[] {lV11ShowNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A40000ShowImagen_GXI = H000V2_A40000ShowImagen_GXI[0];
               AssignProp("", false, edtShowImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A22ShowImagen)) ? A40000ShowImagen_GXI : context.convertURL( context.PathToRelativeUrl( A22ShowImagen))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtShowImagen_Internalname, "SrcSet", context.GetImageSrcSet( A22ShowImagen), true);
               A21ShowNombre = H000V2_A21ShowNombre[0];
               A20ShowId = H000V2_A20ShowId[0];
               A22ShowImagen = H000V2_A22ShowImagen[0];
               AssignProp("", false, edtShowImagen_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A22ShowImagen)) ? A40000ShowImagen_GXI : context.convertURL( context.PathToRelativeUrl( A22ShowImagen))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtShowImagen_Internalname, "SrcSet", context.GetImageSrcSet( A22ShowImagen), true);
               /* Execute user event: Grid.Load */
               E140V2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SHOWID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A20ShowId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11ShowNombre = StringUtil.Concat( StringUtil.RTrim( AV11ShowNombre), "%", "");
         /* Using cursor H000V3 */
         pr_default.execute(1, new Object[] {lV11ShowNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11ShowNombre = GridState.FilterValues("Shownombre");
            AssignAttri("", false, "AV11ShowNombre", AV11ShowNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("ShowNombre", AV11ShowNombre);
      }
      ...
      protected void STRUP0V0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11ShowNombre = cgiGet( edtavShownombre_Internalname);
            AssignAttri("", false, "AV11ShowNombre", AV11ShowNombre);
      ...
      private void E140V2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("show.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A20ShowId,4,0))}, new string[] {"Mode","ShowId"}) ;
         edtavDelete_Link = formatLink("show.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A20ShowId,4,0))}, new string[] {"Mode","ShowId"}) ;
      ...
      protected void E110V2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("show.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","ShowId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Show";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542715353819", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwshow.js", "?202542715353819", false, true);
         }
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtShowImagen_Internalname = "SHOWIMAGEN_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtShowImagen_Internalname = "SHOWIMAGEN_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtShowImagen_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"column column-optional",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A22ShowImagen_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl27( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", context.convertURL( A22ShowImagen));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavShownombre_Internalname = "vSHOWNOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtShowNombre_Enabled = 0;
         edtShowId_Enabled = 0;
         edtavShownombre_Jsonclick = "";
         edtavShownombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ShowNombre","fld":"vSHOWNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140V2","iparms":[{"av":"A20ShowId","fld":"SHOWID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtShowNombre_Link","ctrl":"SHOWNOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110V2","iparms":[{"av":"A20ShowId","fld":"SHOWID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ShowNombre","fld":"vSHOWNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ShowNombre","fld":"vSHOWNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ShowNombre","fld":"vSHOWNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11ShowNombre","fld":"vSHOWNOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11ShowNombre = "";
         H000V2_A40000ShowImagen_GXI = new string[] {""} ;
         H000V2_A21ShowNombre = new string[] {""} ;
         H000V2_A20ShowId = new short[1] ;
         H000V2_A22ShowImagen = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwshow__default(),
            new Object[][] {
                new Object[] {
               H000V2_A40000ShowImagen_GXI, H000V2_A21ShowNombre, H000V2_A20ShowId, H000V2_A22ShowImagen
               }
               , new Object[] {
      ...
      private int edtavShownombre_Enabled ;
      ...
      private string edtavShownombre_Internalname ;
      private string edtavShownombre_Jsonclick ;
      ...
      private string[] H000V2_A40000ShowImagen_GXI ;
      private string[] H000V2_A21ShowNombre ;
      private short[] H000V2_A20ShowId ;
      private string[] H000V2_A22ShowImagen ;
   ...
   public class wwshow__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A21ShowNombre )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11ShowNombre)) )
         {
            AddWhere(sWhereString, "([ShowNombre] like @lV11ShowNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [ShowNombre]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000V2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 1 :
                     return conditional_H000V3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11ShowNombre",GXType.NVarChar,40,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000V2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000V2,1, GxCacheFrequency.OFF ,true,false )
