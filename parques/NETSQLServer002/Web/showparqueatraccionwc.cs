...
namespace GeneXus.Programs {
   public class showparqueatraccionwc : GXWebComponent
   {
      public showparqueatraccionwc( )
      {
      ...
      public showparqueatraccionwc( IGxContext context )
      {
      ...
      public void execute( short aP0_ShowId )
      {
         this.AV6ShowId = aP0_ShowId;
         ExecuteImpl();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "ShowId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6ShowId = (short)(Math.Round(NumberUtil.Val( GetPar( "ShowId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV6ShowId", StringUtil.LTrimStr( (decimal)(AV6ShowId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6ShowId});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "ShowparqueAtraccionWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Showparque Atraccion WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("showparqueatraccionwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6ShowId,4,0))}, new string[] {"ShowId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6ShowId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6ShowId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSHOWID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ShowId), 4, 0, ",", "")));
      ...
      {
         return "ShowparqueAtraccionWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Showparque Atraccion WC" ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "showparqueatraccionwc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ShowparqueAtraccionWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_label_element( context, edtShowId_Internalname, "Show Id", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 38,'" + sPrefix + "',false,'" + sGXsfl_22_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtShowId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A20ShowId), 4, 0, ",", "")), StringUtil.LTrim( ((edtShowId_Enabled!=0) ? context.localUtil.Format( (decimal)(A20ShowId), "ZZZ9") : context.localUtil.Format( (decimal)(A20ShowId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,38);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtShowId_Jsonclick, 0, "Attribute", "", "", "", "", edtShowId_Visible, edtShowId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_ShowparqueAtraccionWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0X2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Showparque Atraccion WC", 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtparqueAtraccionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A17parqueAtraccionFoto)) ? A40000parqueAtraccionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A17parqueAtraccionFoto))), !bGXsfl_22_Refreshing);
                              AssignProp(sPrefix, false, edtparqueAtraccionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A17parqueAtraccionFoto), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PARQUEATRACCIONID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A13parqueAtraccionId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"PARQUEATRACCIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A13parqueAtraccionId), 4, 0, ".", "")));
      }
      ...
      protected void RF0X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000X2 */
            pr_default.execute(0, new Object[] {AV6ShowId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_22_idx = 1;
            sGXsfl_22_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_22_idx), 4, 0), 4, "0");
            SubsflControlProps_222( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A20ShowId = H000X2_A20ShowId[0];
               AssignAttri(sPrefix, false, "A20ShowId", StringUtil.LTrimStr( (decimal)(A20ShowId), 4, 0));
               A23parqueAtraccionShowFechaHora = H000X2_A23parqueAtraccionShowFechaHora[0];
               A29CiudadNombre = H000X2_A29CiudadNombre[0];
               A28CiudadId = H000X2_A28CiudadId[0];
               n28CiudadId = H000X2_n28CiudadId[0];
               A19PaisNombre = H000X2_A19PaisNombre[0];
               A18PaisId = H000X2_A18PaisId[0];
               A40000parqueAtraccionFoto_GXI = H000X2_A40000parqueAtraccionFoto_GXI[0];
               AssignProp(sPrefix, false, edtparqueAtraccionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A17parqueAtraccionFoto)) ? A40000parqueAtraccionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A17parqueAtraccionFoto))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtparqueAtraccionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A17parqueAtraccionFoto), true);
               A16parqueAtraccionDireccion = H000X2_A16parqueAtraccionDireccion[0];
               A15parqueAtraccionSitioWeb = H000X2_A15parqueAtraccionSitioWeb[0];
               A14parqueAtraccionNombre = H000X2_A14parqueAtraccionNombre[0];
               A13parqueAtraccionId = H000X2_A13parqueAtraccionId[0];
               A17parqueAtraccionFoto = H000X2_A17parqueAtraccionFoto[0];
               AssignProp(sPrefix, false, edtparqueAtraccionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A17parqueAtraccionFoto)) ? A40000parqueAtraccionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A17parqueAtraccionFoto))), !bGXsfl_22_Refreshing);
               AssignProp(sPrefix, false, edtparqueAtraccionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A17parqueAtraccionFoto), true);
               A19PaisNombre = H000X2_A19PaisNombre[0];
               A29CiudadNombre = H000X2_A29CiudadNombre[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PARQUEATRACCIONID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A13parqueAtraccionId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H000X3 */
         pr_default.execute(1, new Object[] {AV6ShowId});
      ...
      protected void STRUP0X0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6ShowId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ShowId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E120X2( )
      {
         ...
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtShowId_Visible = 0;
         AssignProp(sPrefix, false, edtShowId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtShowId_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "parqueAtraccion";
         AV11TrnContextAtt = new GeneXus.Programs.general.ui.SdtTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "ShowId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6ShowId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6ShowId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6ShowId", StringUtil.LTrimStr( (decimal)(AV6ShowId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6ShowId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "showparqueatraccionwc", GetJustCreated( ));
         ...
         {
            AV6ShowId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6ShowId", StringUtil.LTrimStr( (decimal)(AV6ShowId), 4, 0));
         }
         wcpOAV6ShowId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6ShowId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV6ShowId = cgiGet( sPrefix+"AV6ShowId_CTRL");
         if ( StringUtil.Len( sCtrlAV6ShowId) > 0 )
         {
            AV6ShowId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6ShowId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6ShowId", StringUtil.LTrimStr( (decimal)(AV6ShowId), 4, 0));
         }
         else
         {
            AV6ShowId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6ShowId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6ShowId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ShowId), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6ShowId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6ShowId_CTRL", StringUtil.RTrim( sCtrlAV6ShowId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541314595486", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("showparqueatraccionwc.js", "?202541314595487", false, true);
         }
      ...
      {
         edtparqueAtraccionId_Internalname = sPrefix+"PARQUEATRACCIONID_"+sGXsfl_22_idx;
         edtparqueAtraccionNombre_Internalname = sPrefix+"PARQUEATRACCIONNOMBRE_"+sGXsfl_22_idx;
         edtparqueAtraccionSitioWeb_Internalname = sPrefix+"PARQUEATRACCIONSITIOWEB_"+sGXsfl_22_idx;
         edtparqueAtraccionDireccion_Internalname = sPrefix+"PARQUEATRACCIONDIRECCION_"+sGXsfl_22_idx;
         edtparqueAtraccionFoto_Internalname = sPrefix+"PARQUEATRACCIONFOTO_"+sGXsfl_22_idx;
         edtPaisId_Internalname = sPrefix+"PAISID_"+sGXsfl_22_idx;
         edtPaisNombre_Internalname = sPrefix+"PAISNOMBRE_"+sGXsfl_22_idx;
         edtCiudadId_Internalname = sPrefix+"CIUDADID_"+sGXsfl_22_idx;
         edtCiudadNombre_Internalname = sPrefix+"CIUDADNOMBRE_"+sGXsfl_22_idx;
         edtparqueAtraccionShowFechaHora_Internalname = sPrefix+"PARQUEATRACCIONSHOWFECHAHORA_"+sGXsfl_22_idx;
      ...
      {
         edtparqueAtraccionId_Internalname = sPrefix+"PARQUEATRACCIONID_"+sGXsfl_22_fel_idx;
         edtparqueAtraccionNombre_Internalname = sPrefix+"PARQUEATRACCIONNOMBRE_"+sGXsfl_22_fel_idx;
         edtparqueAtraccionSitioWeb_Internalname = sPrefix+"PARQUEATRACCIONSITIOWEB_"+sGXsfl_22_fel_idx;
         edtparqueAtraccionDireccion_Internalname = sPrefix+"PARQUEATRACCIONDIRECCION_"+sGXsfl_22_fel_idx;
         edtparqueAtraccionFoto_Internalname = sPrefix+"PARQUEATRACCIONFOTO_"+sGXsfl_22_fel_idx;
         edtPaisId_Internalname = sPrefix+"PAISID_"+sGXsfl_22_fel_idx;
         edtPaisNombre_Internalname = sPrefix+"PAISNOMBRE_"+sGXsfl_22_fel_idx;
         edtCiudadId_Internalname = sPrefix+"CIUDADID_"+sGXsfl_22_fel_idx;
         edtCiudadNombre_Internalname = sPrefix+"CIUDADNOMBRE_"+sGXsfl_22_fel_idx;
         edtparqueAtraccionShowFechaHora_Internalname = sPrefix+"PARQUEATRACCIONSHOWFECHAHORA_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtparqueAtraccionId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A13parqueAtraccionId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A13parqueAtraccionId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtparqueAtraccionId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtparqueAtraccionDireccion_Internalname,(string)A16parqueAtraccionDireccion,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A16parqueAtraccionDireccion),(string)"_blank",(string)"",(string)"",(string)edtparqueAtraccionDireccion_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPaisNombre_Internalname,(string)A19PaisNombre,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtPaisNombre_Link,(string)"",(string)"",(string)"",(string)edtPaisNombre_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)50,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCiudadId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A28CiudadId), 4, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A28CiudadId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCiudadId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtparqueAtraccionShowFechaHora_Internalname,context.localUtil.TToC( A23parqueAtraccionShowFechaHora, 10, 8, 0, 3, "/", ":", " "),context.localUtil.Format( A23parqueAtraccionShowFechaHora, "99/99/99 99:99"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtparqueAtraccionShowFechaHora_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)14,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl22( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Atraccion Nombre") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Sitio Web") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Atraccion Direccion") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"ImageAttribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Atraccion Foto") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtparqueAtraccionFoto_Internalname = sPrefix+"PARQUEATRACCIONFOTO";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ShowId","fld":"vSHOWID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E130X2","iparms":[{"av":"A13parqueAtraccionId","fld":"PARQUEATRACCIONID","pic":"ZZZ9","hsh":true},{"av":"A18PaisId","fld":"PAISID","pic":"ZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtparqueAtraccionNombre_Link","ctrl":"PARQUEATRACCIONNOMBRE","prop":"Link"},{"av":"edtPaisNombre_Link","ctrl":"PAISNOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110X2","iparms":[{"av":"A13parqueAtraccionId","fld":"PARQUEATRACCIONID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ShowId","fld":"vSHOWID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ShowId","fld":"vSHOWID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ShowId","fld":"vSHOWID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6ShowId","fld":"vSHOWID","pic":"ZZZ9"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H000X2_A20ShowId = new short[1] ;
         H000X2_A23parqueAtraccionShowFechaHora = new DateTime[] {DateTime.MinValue} ;
         H000X2_A29CiudadNombre = new string[] {""} ;
         H000X2_A28CiudadId = new short[1] ;
         H000X2_n28CiudadId = new bool[] {false} ;
         H000X2_A19PaisNombre = new string[] {""} ;
         H000X2_A18PaisId = new short[1] ;
         H000X2_A40000parqueAtraccionFoto_GXI = new string[] {""} ;
         H000X2_A16parqueAtraccionDireccion = new string[] {""} ;
         H000X2_A15parqueAtraccionSitioWeb = new string[] {""} ;
         H000X2_A14parqueAtraccionNombre = new string[] {""} ;
         H000X2_A13parqueAtraccionId = new short[1] ;
         H000X2_A17parqueAtraccionFoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.showparqueatraccionwc__default(),
            new Object[][] {
                new Object[] {
               H000X2_A20ShowId, H000X2_A23parqueAtraccionShowFechaHora, H000X2_A29CiudadNombre, H000X2_A28CiudadId, H000X2_n28CiudadId, H000X2_A19PaisNombre, H000X2_A18PaisId, H000X2_A40000parqueAtraccionFoto_GXI, H000X2_A16parqueAtraccionDireccion, H000X2_A15parqueAtraccionSitioWeb,
               H000X2_A14parqueAtraccionNombre, H000X2_A13parqueAtraccionId, H000X2_A17parqueAtraccionFoto
               }
               , new Object[] {
      ...
      private short[] H000X2_A20ShowId ;
      private DateTime[] H000X2_A23parqueAtraccionShowFechaHora ;
      private string[] H000X2_A29CiudadNombre ;
      private short[] H000X2_A28CiudadId ;
      private bool[] H000X2_n28CiudadId ;
      private string[] H000X2_A19PaisNombre ;
      private short[] H000X2_A18PaisId ;
      private string[] H000X2_A40000parqueAtraccionFoto_GXI ;
      private string[] H000X2_A16parqueAtraccionDireccion ;
      private string[] H000X2_A15parqueAtraccionSitioWeb ;
      private string[] H000X2_A14parqueAtraccionNombre ;
      private short[] H000X2_A13parqueAtraccionId ;
      private string[] H000X2_A17parqueAtraccionFoto ;
   ...
   public class showparqueatraccionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6ShowId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000X2", "SELECT T1.[ShowId], T1.[parqueAtraccionShowFechaHora], T3.[CiudadNombre], T1.[CiudadId], T2.[PaisNombre], T1.[PaisId], T1.[parqueAtraccionFoto_GXI], T1.[parqueAtraccionDireccion], T1.[parqueAtraccionSitioWeb], T1.[parqueAtraccionNombre], T1.[parqueAtraccionId], T1.[parqueAtraccionFoto] FROM (([parqueAtraccion] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId]) LEFT JOIN [PaisCiudad] T3 ON T3.[PaisId] = T1.[PaisId] AND T3.[CiudadId] = T1.[CiudadId]) WHERE T1.[ShowId] = @AV6ShowId ORDER BY T1.[ShowId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000X3", "SELECT COUNT(*) FROM (([parqueAtraccion] T1 INNER JOIN [Pais] T2 ON T2.[PaisId] = T1.[PaisId]) LEFT JOIN [PaisCiudad] T3 ON T3.[PaisId] = T1.[PaisId] AND T3.[CiudadId] = T1.[CiudadId]) WHERE T1.[ShowId] = @AV6ShowId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[12])[0] = rslt.getMultimediaFile(12, rslt.getVarchar(7));
                return;
             case 1 :
