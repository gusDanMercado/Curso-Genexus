...
namespace GeneXus.Programs {
   public class gx0030 : GXDataArea
   {
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblpaisidfilter_Internalname, "Pais Id", "", "", lblLblpaisidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11051_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0030.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblpaisnombrefilter_Internalname, "Pais Nombre", "", "", lblLblpaisnombrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12051_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0030.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      protected void RF052( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19PaisNombre = H00052_A19PaisNombre[0];
               A18PaisId = H00052_A18PaisId[0];
               /* Execute user event: Load */
               E15052 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID"+"_"+sGXsfl_34_idx, GetSecureSignedToken( sGXsfl_34_idx, context.localUtil.Format( (decimal)(A18PaisId), "ZZZ9"), context));
      }
      ...
      protected void E14052( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Pais", "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542616524320", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0030.js", "?202542616524320", false, true);
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A18PaisId), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtPaisNombre_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A18PaisId), 4, 0, ",", "")))+"'"+"]);";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("LBLPAISIDFILTER.CLICK","""{"handler":"E11051","iparms":[{"av":"divPaisidfiltercontainer_Class","ctrl":"PAISIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLPAISNOMBREFILTER.CLICK","""{"handler":"E12051","iparms":[{"av":"divPaisnombrefiltercontainer_Class","ctrl":"PAISNOMBREFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E16052","iparms":[{"av":"A18PaisId","fld":"PAISID","pic":"ZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A19PaisNombre = "";
         lV7cPaisNombre = "";
         H00052_A19PaisNombre = new string[] {""} ;
         H00052_A18PaisId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0030__default(),
            new Object[][] {
                new Object[] {
               H00052_A19PaisNombre, H00052_A18PaisId
               }
               , new Object[] {
      ...
      private string[] H00052_A19PaisNombre ;
      private short[] H00052_A18PaisId ;
   ...
   public class gx0030__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00052(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] );
               case 1 :
                     return conditional_H00053(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV7cPaisNombre",GXType.NVarChar,50,0) ,
