...
namespace GeneXus.Programs {
   public class parqueatraccionjuegowc : GXWebComponent
   {
      public parqueatraccionjuegowc( )
      {
      ...
      public parqueatraccionjuegowc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "parqueAtraccionJuegoWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "parque Atraccion Juego WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("parqueatraccionjuegowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6parqueAtraccionId,4,0))}, new string[] {"parqueAtraccionId"}) +"\">") ;
      ...
      {
         return "parqueAtraccionJuegoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "parque Atraccion Juego WC" ;
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "parqueatraccionjuegowc.aspx");
            }
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(22), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_parqueAtraccionJuegoWC.htm");
         ...
         if ( wbEnd == 22 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtparqueAtraccionId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A13parqueAtraccionId), 4, 0, ",", "")), StringUtil.LTrim( ((edtparqueAtraccionId_Enabled!=0) ? context.localUtil.Format( (decimal)(A13parqueAtraccionId), "ZZZ9") : context.localUtil.Format( (decimal)(A13parqueAtraccionId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,32);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtparqueAtraccionId_Jsonclick, 0, "Attribute", "", "", "", "", edtparqueAtraccionId_Visible, edtparqueAtraccionId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_parqueAtraccionJuegoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0T2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "parque Atraccion Juego WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_JUEGOID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A24JuegoId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"JUEGOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A24JuegoId), 4, 0, ".", "")));
      }
      ...
      protected void RF0T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A13parqueAtraccionId = H000T2_A13parqueAtraccionId[0];
               AssignAttri(sPrefix, false, "A13parqueAtraccionId", StringUtil.LTrimStr( (decimal)(A13parqueAtraccionId), 4, 0));
               A27CategoriaNombre = H000T2_A27CategoriaNombre[0];
               A26CategoriaId = H000T2_A26CategoriaId[0];
               n26CategoriaId = H000T2_n26CategoriaId[0];
               A25JuegoNombre = H000T2_A25JuegoNombre[0];
               A24JuegoId = H000T2_A24JuegoId[0];
               A27CategoriaNombre = H000T2_A27CategoriaNombre[0];
               /* Execute user event: Grid.Load */
               E130T2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_JUEGOID"+"_"+sGXsfl_22_idx, GetSecureSignedToken( sPrefix+sGXsfl_22_idx, context.localUtil.Format( (decimal)(A24JuegoId), "ZZZ9"), context));
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Juego";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "parqueatraccionjuegowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202542616524194", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("parqueatraccionjuegowc.js", "?202542616524194", false, true);
         }
      ...
      {
         edtJuegoId_Internalname = sPrefix+"JUEGOID_"+sGXsfl_22_idx;
         edtJuegoNombre_Internalname = sPrefix+"JUEGONOMBRE_"+sGXsfl_22_idx;
      ...
      {
         edtJuegoId_Internalname = sPrefix+"JUEGOID_"+sGXsfl_22_fel_idx;
         edtJuegoNombre_Internalname = sPrefix+"JUEGONOMBRE_"+sGXsfl_22_fel_idx;
      ...
      protected void sendrow_222( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_22_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriaNombre_Internalname,(string)A27CategoriaNombre,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtCategoriaNombre_Link,(string)"",(string)"",(string)"",(string)edtCategoriaNombre_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)22,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E130T2","iparms":[{"av":"A24JuegoId","fld":"JUEGOID","pic":"ZZZ9","hsh":true},{"av":"A26CategoriaId","fld":"CATEGORIAID","pic":"ZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtJuegoNombre_Link","ctrl":"JUEGONOMBRE","prop":"Link"},{"av":"edtCategoriaNombre_Link","ctrl":"CATEGORIANOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110T2","iparms":[{"av":"A24JuegoId","fld":"JUEGOID","pic":"ZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         A25JuegoNombre = "";
         A27CategoriaNombre = "";
         H000T2_A13parqueAtraccionId = new short[1] ;
         H000T2_A27CategoriaNombre = new string[] {""} ;
         H000T2_A26CategoriaId = new short[1] ;
         H000T2_n26CategoriaId = new bool[] {false} ;
         H000T2_A25JuegoNombre = new string[] {""} ;
         H000T2_A24JuegoId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.parqueatraccionjuegowc__default(),
            new Object[][] {
                new Object[] {
               H000T2_A13parqueAtraccionId, H000T2_A27CategoriaNombre, H000T2_A26CategoriaId, H000T2_n26CategoriaId, H000T2_A25JuegoNombre, H000T2_A24JuegoId
               }
               , new Object[] {
      ...
      private short[] H000T2_A13parqueAtraccionId ;
      private string[] H000T2_A27CategoriaNombre ;
      private short[] H000T2_A26CategoriaId ;
      private bool[] H000T2_n26CategoriaId ;
      private string[] H000T2_A25JuegoNombre ;
      private short[] H000T2_A24JuegoId ;
   ...
   public class parqueatraccionjuegowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000T2", "SELECT T1.[parqueAtraccionId], T2.[CategoriaNombre], T1.[CategoriaId], T1.[JuegoNombre], T1.[JuegoId] FROM ([Juego] T1 LEFT JOIN [Categoria] T2 ON T2.[CategoriaId] = T1.[CategoriaId]) WHERE T1.[parqueAtraccionId] = @AV6parqueAtraccionId ORDER BY T1.[parqueAtraccionId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000T3", "SELECT COUNT(*) FROM ([Juego] T1 LEFT JOIN [Categoria] T2 ON T2.[CategoriaId] = T1.[CategoriaId]) WHERE T1.[parqueAtraccionId] = @AV6parqueAtraccionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
