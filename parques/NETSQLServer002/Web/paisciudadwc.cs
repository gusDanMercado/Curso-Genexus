...
namespace GeneXus.Programs {
   public class paisciudadwc : GXWebComponent
   {
      public paisciudadwc( )
      {
      ...
      public paisciudadwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV6PaisId", StringUtil.LTrimStr( (decimal)(AV6PaisId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV6PaisId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV6PaisId, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Pais Ciudad WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("paisciudadwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6PaisId,4,0))}, new string[] {"PaisId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6PaisId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6PaisId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6PaisId), 4, 0, ",", "")));
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "paisciudadwc.aspx");
            }
            /* Div Control */
         ...
         if ( wbEnd == 15 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtPaisId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A18PaisId), 4, 0, ",", "")), StringUtil.LTrim( ((edtPaisId_Enabled!=0) ? context.localUtil.Format( (decimal)(A18PaisId), "ZZZ9") : context.localUtil.Format( (decimal)(A18PaisId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,21);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisId_Jsonclick, 0, "Attribute", "", "", "", "", edtPaisId_Visible, edtPaisId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_PaisCiudadWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0E2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Pais Ciudad WC", 0) ;
            context.wjLoc = "";
      ...
      protected void RF0E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A18PaisId = H000E2_A18PaisId[0];
               AssignAttri(sPrefix, false, "A18PaisId", StringUtil.LTrimStr( (decimal)(A18PaisId), 4, 0));
               A29CiudadNombre = H000E2_A29CiudadNombre[0];
               A28CiudadId = H000E2_A28CiudadId[0];
               /* Execute user event: Grid.Load */
               E120E2 ();
      ...
      protected void STRUP0E0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6PaisId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PaisId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Pais";
         ...
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6PaisId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6PaisId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6PaisId", StringUtil.LTrimStr( (decimal)(AV6PaisId), 4, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "paisciudadwc", GetJustCreated( ));
         ...
         {
            AV6PaisId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6PaisId", StringUtil.LTrimStr( (decimal)(AV6PaisId), 4, 0));
         }
         wcpOAV6PaisId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6PaisId"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6PaisId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV6PaisId), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV6PaisId", StringUtil.LTrimStr( (decimal)(AV6PaisId), 4, 0));
         }
         else
         {
            AV6PaisId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV6PaisId_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6PaisId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6PaisId), 4, 0, ",", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541223451551", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("paisciudadwc.js", "?202541223451551", false, true);
         }
      ...
      {
         edtCiudadId_Internalname = sPrefix+"CIUDADID_"+sGXsfl_15_idx;
         edtCiudadNombre_Internalname = sPrefix+"CIUDADNOMBRE_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtCiudadId_Internalname = sPrefix+"CIUDADID_"+sGXsfl_15_fel_idx;
         edtCiudadNombre_Internalname = sPrefix+"CIUDADNOMBRE_"+sGXsfl_15_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6PaisId","fld":"vPAISID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E120E2","iparms":[]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6PaisId","fld":"vPAISID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6PaisId","fld":"vPAISID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6PaisId","fld":"vPAISID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV6PaisId","fld":"vPAISID","pic":"ZZZ9"},{"av":"sPrefix"}]}""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         A29CiudadNombre = "";
         H000E2_A18PaisId = new short[1] ;
         H000E2_A29CiudadNombre = new string[] {""} ;
         H000E2_A28CiudadId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.paisciudadwc__default(),
            new Object[][] {
                new Object[] {
               H000E2_A18PaisId, H000E2_A29CiudadNombre, H000E2_A28CiudadId
               }
               , new Object[] {
      ...
      private short[] H000E2_A18PaisId ;
      private string[] H000E2_A29CiudadNombre ;
      private short[] H000E2_A28CiudadId ;
   ...
   public class paisciudadwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000E2", "SELECT [PaisId], [CiudadNombre], [CiudadId] FROM [PaisCiudad] WHERE [PaisId] = @AV6PaisId ORDER BY [PaisId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000E2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000E3", "SELECT COUNT(*) FROM [PaisCiudad] WHERE [PaisId] = @AV6PaisId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000E3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
