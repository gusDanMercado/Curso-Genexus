   ...
   public class wwpais : GXDataArea
   {
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPais.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavPaisnombre_Internalname, AV11PaisNombre, StringUtil.RTrim( context.localUtil.Format( AV11PaisNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavPaisnombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavPaisnombre_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPais.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A18PaisId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "PAISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A18PaisId), 4, 0, ".", "")));
      }
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19PaisNombre = H000C2_A19PaisNombre[0];
               A18PaisId = H000C2_A18PaisId[0];
               /* Execute user event: Grid.Load */
               E140C2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAISID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A18PaisId), "ZZZ9"), context));
      }
      ...
      private void E140C2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("pais.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A18PaisId,4,0))}, new string[] {"Mode","PaisId"}) ;
         edtavDelete_Link = formatLink("pais.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A18PaisId,4,0))}, new string[] {"Mode","PaisId"}) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541314595639", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpais.js", "?202541314595639", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E140C2","iparms":[{"av":"A18PaisId","fld":"PAISID","pic":"ZZZ9","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E110C2","iparms":[{"av":"A18PaisId","fld":"PAISID","pic":"ZZZ9","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11PaisNombre = "";
         H000C2_A19PaisNombre = new string[] {""} ;
         H000C2_A18PaisId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpais__default(),
            new Object[][] {
                new Object[] {
               H000C2_A19PaisNombre, H000C2_A18PaisId
               }
               , new Object[] {
      ...
      private string[] H000C2_A19PaisNombre ;
      private short[] H000C2_A18PaisId ;
   ...
   public class wwpais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11PaisNombre",GXType.NVarChar,50,0) ,
