...
namespace GeneXus.Programs {
   public class wwcategoria : GXDataArea
   {
      public wwcategoria( )
      {
      ...
      public wwcategoria( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11CategoriaNombre = GetPar( "CategoriaNombre");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11CategoriaNombre, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwcategoria.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCATEGORIANOMBRE", AV11CategoriaNombre);
         /* Send saved values. */
      ...
      {
         return formatLink("wwcategoria.aspx")  ;
      }
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Categorias", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWCategoria.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWCategoria.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavCategorianombre_Internalname, "Categoria Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCategorianombre_Internalname, AV11CategoriaNombre, StringUtil.RTrim( context.localUtil.Format( AV11CategoriaNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavCategorianombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavCategorianombre_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWCategoria.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Categorianombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCATEGORIANOMBRE"), AV11CategoriaNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0G2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavCategorianombre_Internalname;
      ...
      protected void RF0G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11CategoriaNombre = StringUtil.Concat( StringUtil.RTrim( AV11CategoriaNombre), "%", "");
            /* Using cursor H000G2 */
            pr_default.execute(0, new Object[] {lV11CategoriaNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A27CategoriaNombre = H000G2_A27CategoriaNombre[0];
               A26CategoriaId = H000G2_A26CategoriaId[0];
               /* Execute user event: Grid.Load */
               E140G2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGORIAID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A26CategoriaId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11CategoriaNombre = StringUtil.Concat( StringUtil.RTrim( AV11CategoriaNombre), "%", "");
         /* Using cursor H000G3 */
         pr_default.execute(1, new Object[] {lV11CategoriaNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11CategoriaNombre = GridState.FilterValues("Categorianombre");
            AssignAttri("", false, "AV11CategoriaNombre", AV11CategoriaNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("CategoriaNombre", AV11CategoriaNombre);
      }
      ...
      protected void STRUP0G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11CategoriaNombre = cgiGet( edtavCategorianombre_Internalname);
            AssignAttri("", false, "AV11CategoriaNombre", AV11CategoriaNombre);
      ...
      private void E140G2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("categoria.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A26CategoriaId,4,0))}, new string[] {"Mode","CategoriaId"}) ;
         edtavDelete_Link = formatLink("categoria.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A26CategoriaId,4,0))}, new string[] {"Mode","CategoriaId"}) ;
      ...
      protected void E110G2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("categoria.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","CategoriaId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Categoria";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541314595649", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwcategoria.js", "?202541314595649", false, true);
         }
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 30,'',false,'" + sGXsfl_27_idx + "',27)\"";
      ...
      protected void init_default_properties( )
      {
         ...
         edtavCategorianombre_Internalname = "vCATEGORIANOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtCategoriaNombre_Enabled = 0;
         edtCategoriaId_Enabled = 0;
         edtavCategorianombre_Jsonclick = "";
         edtavCategorianombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CategoriaNombre","fld":"vCATEGORIANOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140G2","iparms":[{"av":"A26CategoriaId","fld":"CATEGORIAID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtCategoriaNombre_Link","ctrl":"CATEGORIANOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110G2","iparms":[{"av":"A26CategoriaId","fld":"CATEGORIAID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CategoriaNombre","fld":"vCATEGORIANOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CategoriaNombre","fld":"vCATEGORIANOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CategoriaNombre","fld":"vCATEGORIANOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11CategoriaNombre","fld":"vCATEGORIANOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11CategoriaNombre = "";
         H000G2_A27CategoriaNombre = new string[] {""} ;
         H000G2_A26CategoriaId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwcategoria__default(),
            new Object[][] {
                new Object[] {
               H000G2_A27CategoriaNombre, H000G2_A26CategoriaId
               }
               , new Object[] {
      ...
      private int edtavCategorianombre_Enabled ;
      ...
      private string edtavCategorianombre_Internalname ;
      private string edtavCategorianombre_Jsonclick ;
      ...
      private string AV11CategoriaNombre ;
      private string A27CategoriaNombre ;
      private string lV11CategoriaNombre ;
      ...
      private string[] H000G2_A27CategoriaNombre ;
      private short[] H000G2_A26CategoriaId ;
   ...
   public class wwcategoria__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A27CategoriaNombre )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11CategoriaNombre)) )
         {
            AddWhere(sWhereString, "([CategoriaNombre] like @lV11CategoriaNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [CategoriaNombre]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11CategoriaNombre",GXType.NVarChar,40,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000G2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H000G3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
