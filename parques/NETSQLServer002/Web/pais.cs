   ...
   public class pais : GXDataArea
   {
      ...
      protected void ZM033( short GX_JID )
      {
         if ( ( GX_JID == 2 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z19PaisNombre = T00033_A19PaisNombre[0];
            }
            else
            {
      ...
      protected void Load033( )
      {
         ...
         {
            RcdFound3 = 1;
            A19PaisNombre = T00034_A19PaisNombre[0];
            AssignAttri("", false, "A19PaisNombre", A19PaisNombre);
            ZM033( -2) ;
         }
         pr_default.close(2);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM033( 2) ;
            RcdFound3 = 1;
            A18PaisId = T00033_A18PaisId[0];
            AssignAttri("", false, "A18PaisId", StringUtil.LTrimStr( (decimal)(A18PaisId), 4, 0));
            A19PaisNombre = T00033_A19PaisNombre[0];
            AssignAttri("", false, "A19PaisNombre", A19PaisNombre);
            Z18PaisId = A18PaisId;
            sMode3 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( T00036_A18PaisId[0] < A18PaisId ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( T00036_A18PaisId[0] > A18PaisId ) ) )
            {
               A18PaisId = T00036_A18PaisId[0];
               AssignAttri("", false, "A18PaisId", StringUtil.LTrimStr( (decimal)(A18PaisId), 4, 0));
               RcdFound3 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( T00037_A18PaisId[0] > A18PaisId ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( T00037_A18PaisId[0] < A18PaisId ) ) )
            {
               A18PaisId = T00037_A18PaisId[0];
               AssignAttri("", false, "A18PaisId", StringUtil.LTrimStr( (decimal)(A18PaisId), 4, 0));
               RcdFound3 = 1;
            }
         }
      ...
      protected void btn_get( )
      {
         ...
         if ( RcdFound3 == 0 )
         {
            GX_msglist.addItem(context.GetMessage( "GXM_keynfound", ""), "PrimaryKeyNotFound", 1, "PAISID");
            AnyError = 1;
            GX_FocusControl = edtPaisId_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void CheckOptimisticConcurrency033( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z19PaisNombre, T00032_A19PaisNombre[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z19PaisNombre, T00032_A19PaisNombre[0]) != 0 )
               {
                  GXUtil.WriteLog("pais:[seudo value changed for attri]"+"PaisNombre");
                  GXUtil.WriteLogRaw("Old: ",Z19PaisNombre);
                  GXUtil.WriteLogRaw("Current: ",T00032_A19PaisNombre[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00038 */
                     pr_default.execute(6, new Object[] {A19PaisNombre});
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00039 */
                     pr_default.execute(7, new Object[] {A19PaisNombre, A18PaisId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Pais");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(8, new Object[] {A18PaisId});
                  pr_default.close(8);
                  pr_default.SmartCacheProvider.SetUpdated("Pais");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls033( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(9, new Object[] {A18PaisId});
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("pais.js", "?20254122151261", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_PAISID","""{"handler":"Valid_Paisid","iparms":[{"av":"A18PaisId","fld":"PAISID","pic":"ZZZ9"},{"av":"Gx_BScreen","fld":"vGXBSCREEN","pic":"9"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"}]""");
         setEventMetadata("VALID_PAISID",""","oparms":[{"av":"A19PaisNombre","fld":"PAISNOMBRE"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"Z18PaisId"},{"av":"Z19PaisNombre"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         T00033_A19PaisNombre = new string[] {""} ;
         sMode3 = "";
         T00036_A18PaisId = new short[1] ;
         T00037_A18PaisId = new short[1] ;
         T00032_A18PaisId = new short[1] ;
         T00032_A19PaisNombre = new string[] {""} ;
         T00038_A18PaisId = new short[1] ;
         T000311_A13parqueAtraccionId = new short[1] ;
         T000312_A18PaisId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ19PaisNombre = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pais__default(),
            new Object[][] {
                new Object[] {
               T00032_A18PaisId, T00032_A19PaisNombre
               }
               , new Object[] {
               T00033_A18PaisId, T00033_A19PaisNombre
               }
               , new Object[] {
      ...
      private string[] T00033_A19PaisNombre ;
      private short[] T00036_A18PaisId ;
      private short[] T00037_A18PaisId ;
      private short[] T00032_A18PaisId ;
      private string[] T00032_A19PaisNombre ;
      private short[] T00038_A18PaisId ;
      private short[] T000311_A13parqueAtraccionId ;
      private short[] T000312_A18PaisId ;
   }
   ...
   public class pais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("T00032", "SELECT [PaisId], [PaisNombre] FROM [Pais] WITH (UPDLOCK) WHERE [PaisId] = @PaisId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00032,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00033", "SELECT [PaisId], [PaisNombre] FROM [Pais] WHERE [PaisId] = @PaisId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00033,1, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("T00034", "SELECT TM1.[PaisId], TM1.[PaisNombre] FROM [Pais] TM1 WHERE TM1.[PaisId] = @PaisId ORDER BY TM1.[PaisId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT00034,100, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("T00038", "INSERT INTO [Pais]([PaisNombre]) VALUES(@PaisNombre); SELECT SCOPE_IDENTITY()",true, GxErrorMask.GX_NOMASK, false, this,prmT00038,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T00039", "UPDATE [Pais] SET [PaisNombre]=@PaisNombre  WHERE [PaisId] = @PaisId", GxErrorMask.GX_NOMASK,prmT00039)
             ,new CursorDef("T000310", "DELETE FROM [Pais]  WHERE [PaisId] = @PaisId", GxErrorMask.GX_NOMASK,prmT000310)
             ,new CursorDef("T000311", "SELECT TOP 1 [parqueAtraccionId] FROM [parqueAtraccion] WHERE [PaisId] = @PaisId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000311,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("T000312", "SELECT [PaisId] FROM [Pais] ORDER BY [PaisId]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000312,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
