...
namespace GeneXus.Programs {
   public class viewpais : GXDataArea
   {
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("PaisNombre", StringUtil.RTrim( context.localUtil.Format( A19PaisNombre, "")));
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtPaisNombre_Internalname, A19PaisNombre, StringUtil.RTrim( context.localUtil.Format( A19PaisNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPaisNombre_Jsonclick, 0, "heading-01", "", "", "", "", 1, edtPaisNombre_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_ViewPais.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCiudad_title_Internalname, "Ciudad", "", "", lblCiudad_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewPais.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableciudad_Internalname, 1, 0, "px", 0, "px", "ww__view__tab__form-container", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0034"+"", StringUtil.RTrim( WebComp_Ciudadwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 34 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Ciudadwc_Component) != 0 )
                           {
                              WebComp_Ciudadwc.componentprocess("W0034", "", sEvt);
                           }
                           WebComp_Ciudadwc_Component = OldCiudadwc;
                        }
                     }
      ...
      protected void RF0B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A18PaisId = H000B2_A18PaisId[0];
               A19PaisNombre = H000B2_A19PaisNombre[0];
      ...
      protected void E110B2( )
      {
         ...
         {
            A18PaisId = H000B3_A18PaisId[0];
            A19PaisNombre = H000B3_A19PaisNombre[0];
            AssignAttri("", false, "A19PaisNombre", A19PaisNombre);
            AV14GXLvl7 = 1;
            Form.Caption = A19PaisNombre;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Ciudad") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Ciudadwc_Component) != 0 )
            {
               ...
               WebComp_Ciudadwc.componentprepare(new Object[] {(string)"W0034",(string)"",(short)AV12PaisId});
               WebComp_Ciudadwc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Ciudadwc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0034"+"");
               WebComp_Ciudadwc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541223451689", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewpais.js", "?202541223451689", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12PaisId","fld":"vPAISID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A19PaisNombre","fld":"PAISNOMBRE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000B2_A18PaisId = new short[1] ;
         H000B2_A19PaisNombre = new string[] {""} ;
         hsh = "";
         H000B3_A18PaisId = new short[1] ;
         H000B3_A19PaisNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewpais__default(),
            new Object[][] {
                new Object[] {
               H000B2_A18PaisId, H000B2_A19PaisNombre
               }
               , new Object[] {
               H000B3_A18PaisId, H000B3_A19PaisNombre
               }
            }
         );
      ...
      private bool bDynCreated_Ciudadwc ;
      ...
      private short[] H000B2_A18PaisId ;
      private string[] H000B2_A19PaisNombre ;
      private short[] H000B3_A18PaisId ;
      private string[] H000B3_A19PaisNombre ;
   ...
   public class viewpais__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "SELECT [PaisId], [PaisNombre] FROM [Pais] WHERE [PaisId] = @AV12PaisId ORDER BY [PaisId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000B3", "SELECT [PaisId], [PaisNombre] FROM [Pais] WHERE [PaisId] = @AV12PaisId ORDER BY [PaisId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
