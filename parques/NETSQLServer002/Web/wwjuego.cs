...
namespace GeneXus.Programs {
   public class wwjuego : GXDataArea
   {
      public wwjuego( )
      {
      ...
      public wwjuego( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV11JuegoNombre = GetPar( "JuegoNombre");
         AV12Update = GetPar( "Update");
         AV13Delete = GetPar( "Delete");
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         ...
         gxgrGrid_refresh( subGrid_Rows, AV11JuegoNombre, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwjuego.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vJUEGONOMBRE", AV11JuegoNombre);
         /* Send saved values. */
      ...
      {
         return formatLink("wwjuego.aspx")  ;
      }
      ...
      protected void WB0N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Juegos", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "heading-01", 0, "", 1, 1, 0, 0, "HLP_WWJuego.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(27), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWJuego.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavJuegonombre_Internalname, "Juego Nombre", "gx-form-item attribute-searchLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 18,'',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavJuegonombre_Internalname, AV11JuegoNombre, StringUtil.RTrim( context.localUtil.Format( AV11JuegoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre", edtavJuegonombre_Jsonclick, 0, "attribute-search", "", "", "", "", 1, edtavJuegonombre_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWJuego.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0N2( )
      {
         ...
         Form.Meta.addItem("description", "Juegos", 0) ;
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Juegonombre Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vJUEGONOMBRE"), AV11JuegoNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0N2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavJuegonombre_Internalname;
      ...
      protected void RF0N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11JuegoNombre = StringUtil.Concat( StringUtil.RTrim( AV11JuegoNombre), "%", "");
            /* Using cursor H000N2 */
            pr_default.execute(0, new Object[] {lV11JuegoNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_27_idx), 4, 0), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A27CategoriaNombre = H000N2_A27CategoriaNombre[0];
               A26CategoriaId = H000N2_A26CategoriaId[0];
               n26CategoriaId = H000N2_n26CategoriaId[0];
               A40000parqueAtraccionFoto_GXI = H000N2_A40000parqueAtraccionFoto_GXI[0];
               AssignProp("", false, edtparqueAtraccionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A17parqueAtraccionFoto)) ? A40000parqueAtraccionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A17parqueAtraccionFoto))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtparqueAtraccionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A17parqueAtraccionFoto), true);
               A15parqueAtraccionSitioWeb = H000N2_A15parqueAtraccionSitioWeb[0];
               A14parqueAtraccionNombre = H000N2_A14parqueAtraccionNombre[0];
               A13parqueAtraccionId = H000N2_A13parqueAtraccionId[0];
               A25JuegoNombre = H000N2_A25JuegoNombre[0];
               A24JuegoId = H000N2_A24JuegoId[0];
               A17parqueAtraccionFoto = H000N2_A17parqueAtraccionFoto[0];
               AssignProp("", false, edtparqueAtraccionFoto_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A17parqueAtraccionFoto)) ? A40000parqueAtraccionFoto_GXI : context.convertURL( context.PathToRelativeUrl( A17parqueAtraccionFoto))), !bGXsfl_27_Refreshing);
               AssignProp("", false, edtparqueAtraccionFoto_Internalname, "SrcSet", context.GetImageSrcSet( A17parqueAtraccionFoto), true);
               A27CategoriaNombre = H000N2_A27CategoriaNombre[0];
               A40000parqueAtraccionFoto_GXI = H000N2_A40000parqueAtraccionFoto_GXI[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_JUEGOID"+"_"+sGXsfl_27_idx, GetSecureSignedToken( sGXsfl_27_idx, context.localUtil.Format( (decimal)(A24JuegoId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11JuegoNombre = StringUtil.Concat( StringUtil.RTrim( AV11JuegoNombre), "%", "");
         /* Using cursor H000N3 */
         pr_default.execute(1, new Object[] {lV11JuegoNombre});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11JuegoNombre = GridState.FilterValues("Juegonombre");
            AssignAttri("", false, "AV11JuegoNombre", AV11JuegoNombre);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("JuegoNombre", AV11JuegoNombre);
      }
      ...
      protected void STRUP0N0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11JuegoNombre = cgiGet( edtavJuegonombre_Internalname);
            AssignAttri("", false, "AV11JuegoNombre", AV11JuegoNombre);
      ...
      private void E140N2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("juego.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A24JuegoId,4,0))}, new string[] {"Mode","JuegoId"}) ;
         edtavDelete_Link = formatLink("juego.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A24JuegoId,4,0))}, new string[] {"Mode","JuegoId"}) ;
         edtJuegoNombre_Link = formatLink("viewjuego.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A24JuegoId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"JuegoId","TabCode"}) ;
      ...
      protected void E110N2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("juego.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","JuegoId"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Juego";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541314595674", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwjuego.js", "?202541314595674", false, true);
         }
      ...
      {
         edtJuegoId_Internalname = "JUEGOID_"+sGXsfl_27_idx;
         edtJuegoNombre_Internalname = "JUEGONOMBRE_"+sGXsfl_27_idx;
      ...
      {
         edtJuegoId_Internalname = "JUEGOID_"+sGXsfl_27_fel_idx;
         edtJuegoNombre_Internalname = "JUEGONOMBRE_"+sGXsfl_27_fel_idx;
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCategoriaNombre_Internalname,(string)A27CategoriaNombre,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtCategoriaNombre_Link,(string)"",(string)"",(string)"",(string)edtCategoriaNombre_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"column column-optional",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 36,'',false,'" + sGXsfl_27_idx + "',27)\"";
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 37,'',false,'" + sGXsfl_27_idx + "',27)\"";
            ROClassString = "TextActionAttribute TextLikeLink";
      ...
      protected void StartGridControl27( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "parque Atraccion Sitio Web") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"ImageAttribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "parque Atraccion Foto") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A24JuegoId), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A25JuegoNombre));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtJuegoNombre_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A26CategoriaId), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A27CategoriaNombre));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavJuegonombre_Internalname = "vJUEGONOMBRE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtJuegoNombre_Enabled = 0;
         edtJuegoId_Enabled = 0;
         edtavJuegonombre_Jsonclick = "";
         edtavJuegonombre_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11JuegoNombre","fld":"vJUEGONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E140N2","iparms":[{"av":"A24JuegoId","fld":"JUEGOID","pic":"ZZZ9","hsh":true},{"av":"A13parqueAtraccionId","fld":"PARQUEATRACCIONID","pic":"ZZZ9"},{"av":"A26CategoriaId","fld":"CATEGORIAID","pic":"ZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtJuegoNombre_Link","ctrl":"JUEGONOMBRE","prop":"Link"},{"av":"edtparqueAtraccionNombre_Link","ctrl":"PARQUEATRACCIONNOMBRE","prop":"Link"},{"av":"edtCategoriaNombre_Link","ctrl":"CATEGORIANOMBRE","prop":"Link"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E110N2","iparms":[{"av":"A24JuegoId","fld":"JUEGOID","pic":"ZZZ9","hsh":true}]}""");
         setEventMetadata("GRID_FIRSTPAGE","""{"handler":"subgrid_firstpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11JuegoNombre","fld":"vJUEGONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_PREVPAGE","""{"handler":"subgrid_previouspage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11JuegoNombre","fld":"vJUEGONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_NEXTPAGE","""{"handler":"subgrid_nextpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11JuegoNombre","fld":"vJUEGONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
         setEventMetadata("GRID_LASTPAGE","""{"handler":"subgrid_lastpage","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11JuegoNombre","fld":"vJUEGONOMBRE"},{"av":"AV12Update","fld":"vUPDATE"},{"av":"AV13Delete","fld":"vDELETE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         lV11JuegoNombre = "";
         H000N2_A27CategoriaNombre = new string[] {""} ;
         H000N2_A26CategoriaId = new short[1] ;
         H000N2_n26CategoriaId = new bool[] {false} ;
         H000N2_A40000parqueAtraccionFoto_GXI = new string[] {""} ;
         H000N2_A15parqueAtraccionSitioWeb = new string[] {""} ;
         H000N2_A14parqueAtraccionNombre = new string[] {""} ;
         H000N2_A13parqueAtraccionId = new short[1] ;
         H000N2_A25JuegoNombre = new string[] {""} ;
         H000N2_A24JuegoId = new short[1] ;
         H000N2_A17parqueAtraccionFoto = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwjuego__default(),
            new Object[][] {
                new Object[] {
               H000N2_A27CategoriaNombre, H000N2_A26CategoriaId, H000N2_n26CategoriaId, H000N2_A40000parqueAtraccionFoto_GXI, H000N2_A15parqueAtraccionSitioWeb, H000N2_A14parqueAtraccionNombre, H000N2_A13parqueAtraccionId, H000N2_A25JuegoNombre, H000N2_A24JuegoId, H000N2_A17parqueAtraccionFoto
               }
               , new Object[] {
      ...
      private int edtavJuegonombre_Enabled ;
      ...
      private string edtavJuegonombre_Internalname ;
      private string edtavJuegonombre_Jsonclick ;
      ...
      private string AV11JuegoNombre ;
      ...
      private string lV11JuegoNombre ;
      ...
      private string[] H000N2_A27CategoriaNombre ;
      private short[] H000N2_A26CategoriaId ;
      private bool[] H000N2_n26CategoriaId ;
      private string[] H000N2_A40000parqueAtraccionFoto_GXI ;
      private string[] H000N2_A15parqueAtraccionSitioWeb ;
      private string[] H000N2_A14parqueAtraccionNombre ;
      private short[] H000N2_A13parqueAtraccionId ;
      private string[] H000N2_A25JuegoNombre ;
      private short[] H000N2_A24JuegoId ;
      private string[] H000N2_A17parqueAtraccionFoto ;
   ...
   public class wwjuego__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A25JuegoNombre )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[CategoriaNombre], T1.[CategoriaId], T3.[parqueAtraccionFoto_GXI], T3.[parqueAtraccionSitioWeb], T3.[parqueAtraccionNombre], T1.[parqueAtraccionId], T1.[JuegoNombre], T1.[JuegoId], T3.[parqueAtraccionFoto]";
         sFromString = " FROM (([Juego] T1 LEFT JOIN [Categoria] T2 ON T2.[CategoriaId] = T1.[CategoriaId]) INNER JOIN [parqueAtraccion] T3 ON T3.[parqueAtraccionId] = T1.[parqueAtraccionId])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11JuegoNombre)) )
         {
            AddWhere(sWhereString, "(T1.[JuegoNombre] like @lV11JuegoNombre)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[JuegoNombre]";
                                             ...
                                             string A25JuegoNombre )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([Juego] T1 LEFT JOIN [Categoria] T3 ON T3.[CategoriaId] = T1.[CategoriaId]) INNER JOIN [parqueAtraccion] T2 ON T2.[parqueAtraccionId] = T1.[parqueAtraccionId])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11JuegoNombre)) )
         {
            AddWhere(sWhereString, "(T1.[JuegoNombre] like @lV11JuegoNombre)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11JuegoNombre",GXType.NVarChar,40,0) ,
