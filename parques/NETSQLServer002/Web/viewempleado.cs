...
namespace GeneXus.Programs {
   public class viewempleado : GXDataArea
   {
      public viewempleado( )
      {
      ...
      public viewempleado( IGxContext context )
      {
      ...
      public void execute( short aP0_EmpleadoId ,
                           string aP1_TabCode )
      {
         this.AV12EmpleadoId = aP0_EmpleadoId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12EmpleadoId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12EmpleadoId", StringUtil.LTrimStr( (decimal)(AV12EmpleadoId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vEMPLEADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpleadoId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewempleado.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmpleadoId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EmpleadoId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vEMPLEADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12EmpleadoId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPLEADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpleadoId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "vTABCODE", StringUtil.RTrim( AV6TabCode));
         GxWebStd.gx_hidden_field( context, "gxhash_vTABCODE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6TabCode, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewEmpleado");
         forbiddenHiddens.Add("EmpleadoNombre", StringUtil.RTrim( context.localUtil.Format( A2EmpleadoNombre, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewempleado:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("viewempleado.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmpleadoId,4,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"EmpleadoId","TabCode"})  ;
      }
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Empleados", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "ww__view__button-back", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewEmpleado.htm");
            ...
            GxWebStd.gx_label_element( context, edtEmpleadoNombre_Internalname, "Nombre", "gx-form-item heading-01Label", 0, true, "width: 25%;");
            /* Multiple line edit */
            ...
            ClassString = "heading-01";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtEmpleadoNombre_Internalname, A2EmpleadoNombre, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,15);\"", 0, 1, edtEmpleadoNombre_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "1024", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_ViewEmpleado.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewEmpleado.htm");
            /* Div Control */
      ...
      protected void START0J2( )
      {
         ...
         Form.Meta.addItem("description", "View Empleado", 0) ;
         context.wjLoc = "";
      ...
      protected void RF0J2( )
      {
         ...
         {
            /* Using cursor H000J2 */
            pr_default.execute(0, new Object[] {AV12EmpleadoId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A1EmpleadoId = H000J2_A1EmpleadoId[0];
               A2EmpleadoNombre = H000J2_A2EmpleadoNombre[0];
      ...
      protected void STRUP0J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12EmpleadoId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vEMPLEADOID"), ",", "."), 18, MidpointRounding.ToEven));
            ...
            {
               GXUtil.WriteLogError("viewempleado:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110J2( )
      {
         ...
         AV14GXLvl7 = 0;
         /* Using cursor H000J3 */
         pr_default.execute(1, new Object[] {AV12EmpleadoId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A1EmpleadoId = H000J3_A1EmpleadoId[0];
            A2EmpleadoNombre = H000J3_A2EmpleadoNombre[0];
            AssignAttri("", false, "A2EmpleadoNombre", A2EmpleadoNombre);
            AV14GXLvl7 = 1;
            Form.Caption = A2EmpleadoNombre;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwempleado.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "EmpleadoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "empleadogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "EmpleadoGeneral";
               WebComp_Generalwc_Component = "EmpleadoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0026",(string)"",(short)AV12EmpleadoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12EmpleadoId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12EmpleadoId", StringUtil.LTrimStr( (decimal)(AV12EmpleadoId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPLEADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpleadoId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202541314595642", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewempleado.js", "?202541314595643", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV12EmpleadoId","fld":"vEMPLEADOID","pic":"ZZZ9","hsh":true},{"av":"AV6TabCode","fld":"vTABCODE","hsh":true},{"av":"A2EmpleadoNombre","fld":"EMPLEADONOMBRE"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV13Pgmname = "";
         H000J2_A1EmpleadoId = new short[1] ;
         H000J2_A2EmpleadoNombre = new string[] {""} ;
         hsh = "";
         H000J3_A1EmpleadoId = new short[1] ;
         H000J3_A2EmpleadoNombre = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewempleado__default(),
            new Object[][] {
                new Object[] {
               H000J2_A1EmpleadoId, H000J2_A2EmpleadoNombre
               }
               , new Object[] {
               H000J3_A1EmpleadoId, H000J3_A2EmpleadoNombre
               }
            }
         );
      ...
      private short AV12EmpleadoId ;
      private short wcpOAV12EmpleadoId ;
      ...
      private short[] H000J2_A1EmpleadoId ;
      private string[] H000J2_A2EmpleadoNombre ;
      private short[] H000J3_A1EmpleadoId ;
      private string[] H000J3_A2EmpleadoNombre ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewempleado__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12EmpleadoId",GXType.Int16,4,0)
          };
          Object[] prmH000J3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000J2", "SELECT [EmpleadoId], [EmpleadoNombre] FROM [Empleado] WHERE [EmpleadoId] = @AV12EmpleadoId ORDER BY [EmpleadoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000J3", "SELECT [EmpleadoId], [EmpleadoNombre] FROM [Empleado] WHERE [EmpleadoId] = @AV12EmpleadoId ORDER BY [EmpleadoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
