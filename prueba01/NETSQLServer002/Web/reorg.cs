...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      public reorg( )
      {
         ...
         IsMain = true;
         context.SetDefaultTheme("prueba01", false);
      }
      ...
      public void CreateTransaccionprueba( )
      {
         string cmdBuffer = "";
         /* Indices for table Transaccionprueba */
         try
         {
            cmdBuffer=" CREATE TABLE [Transaccionprueba] ([TransaccionpruebaId] smallint NOT NULL , PRIMARY KEY([TransaccionpruebaId]))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               DropTableConstraints( "[Transaccionprueba]") ;
               cmdBuffer=" DROP TABLE [Transaccionprueba] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch
            {
               ...
               {
                  DropTableConstraints( "[Transaccionprueba]") ;
                  cmdBuffer=" DROP VIEW [Transaccionprueba] "
                  ;
                  RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                  RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
                  RGZ.ExecuteStmt() ;
               ...
               catch
               {
                  ...
                  {
                     DropTableConstraints( "[Transaccionprueba]") ;
                     cmdBuffer=" DROP FUNCTION [Transaccionprueba] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( tableexist("Transaccionprueba",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"Transaccionprueba"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateTransaccionprueba" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Transaccionprueba", ""}) );
      }
